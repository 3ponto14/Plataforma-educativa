...
var BANCO8={
  questoes:[
    ...
    {id:'q8-12',tema:2,visual:svgStemLeaf([3,4],[['5','7','8'],['0','1','4','6']]),enunciado:'Um diagrama de caule-e-folhas tem caule 3 com folhas 5,7,8 e caule 4 com folhas 0,1,4,6. Qual é a mediana?',opts:['A) 38','B) 40','C) 41','D) 43'],correct:'B',fb:'Passo 1 ler os valores do diagrama:\nCaule 3: 35, 37, 38\nCaule 4: 40, 41, 44, 46\nPasso 2 total de 7 valores (ímpar) → mediana = valor na posição (7+1)/2 = 4.ª posição.\nContando em ordem crescente: 35, 37, 38, 40, 41, 44, 46 → 4.º valor = 40. ✓'},
    // TEMA 3 Representações gráficas
    {id:'q8-13',tema:3,visual:svgHistogram({labels:['Cat. A (30%)','Cat. B (20%)','Cat. C','Cat. D'],values:[30,20,25,25],color:'#516860',title:'Gráfico de barras (exemplo)'}),enunciado:'Num gráfico de barras, 30% dos dados são representados por uma barra com 4 cm de altura. Qual é a altura da barra que representa 20% dos dados?',opts:['A) 2 cm','B) 2,5 cm','C) 2,67 cm','D) 3 cm'],correct:'C',fb:'As alturas das barras são proporcionais às frequências.\nRegra de três: 30% → 4 cm, então 20% → ?\nAltura = 4 × (20/30) = 4 × (2/3) = 8/3 ≈ 2,67 cm. ✓'},
    {id:'q8-14',tema:3,visual:svgHistogram({labels:['2012','2013','2014','2015','2016','2017','2018','2019','2020','2021'],values:[22,26,20,24,21,25,18,23,20,24],color:'#2a7ae2',title:'Melhores marcadores 1.ª Liga (golos)'}),enunciado:'No gráfico dos melhores marcadores da 1.ª liga (2012-2021), o menor número de golos registou-se em:',opts:['A) 2012','B) 2015','C) 2018','D) 2020'],correct:'C',fb:'Para encontrar o menor valor num gráfico: identificar a barra/ponto mais baixo.\nO valor mínimo (18 golos) está em 2018/2019. ✓'},
    ...
    {id:'q8-16',tema:3,visual:svgHistogram({labels:['[25;30[','[30;35[','[35;40[','[40;45[','[45;50['],values:[0.10,0.15,0.20,0.35,0.20],color:'#e07c2a',title:'Histograma frequências relativas'}),enunciado:'Num histograma, uma classe [30; 35[ tem frequência relativa 0,15 e outra [35; 40[ tem frequência relativa 0,20. Para uma amostra de 40 alunos, quantos estão na classe [30; 40[?',opts:['A) 12','B) 14','C) 16','D) 18'],correct:'B',fb:'Passo 1 calcular os alunos em cada classe:\n[30; 35[: frequência absoluta = 0,15 × 40 = 6 alunos\n[35; 40[: frequência absoluta = 0,20 × 40 = 8 alunos\nPasso 2 total na classe [30; 40[:\n6 + 8 = 14 alunos. ✓'},
