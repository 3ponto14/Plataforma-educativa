...
Assim, pela definição de probabilidade condicionada, temos q' },
    ...
    { id:'m12-24f2-9', num:'9', page:7, tipo:'dev', tema:'probabilidades',
      ...
      resolucao:'Como a função y representa a oscilação da extremidade da mola em relação à posição de equilı́brio,
em centı́metros, os instantes em que a extremidade da mola está meio centı́metro abaixo são as
...
Assim, visualizando na calculadora gráfica o
gráfico das funções f (x) = 7,5e−1,5x sen (8,6x+1,6)
e g(x) = −0,5, com x ∈ [0,1], reproduzido na figura ao lado, e usando a função da calculadora
para determinar valores aproximados das coordenadas do ponto de interseção de dois gráficos, obtemos o valor aproximado (às centésimas) da abcissa
do ponto de interseção que tem menor abcissa, ou
seja, o primeiro dos três instantes considerados:
...
• Como f ′ é estritamente crescente no intervalo ]0, + ∞[, então a respetiva função derivada, (f ′ ) , ou
seja, f ′′ , é positiva no mesmo i' }
  ]
},
...
calcular o valor do primeiro termo, u1 , ou seja, o comprimento do segmento de reta [AB], em cen' },
    ...
    { id:'m12-23f1-3', num:'3', page:2, tipo:'dev', tema:'logaritmos',
      ...
      resolucao:'Para estudar o sentido o sentido das concavidades e a existência de pontos de inflexão, começamos por
determinar a expressão da segunda derivada:


′
′
...
= −2e1−x − 2x (0 − 2x) e1−x = −2e1−x + 4x2 e1−x = e1−x
Determinando os zeros da segunda derivada, vem:

2
2
f ′′ (x) = 0 ⇔ e1−x −2 + 4x2 = 0 ⇔ e|1−x{z = 0}
...
Assim, estudando a variação de sinal de f ′′ e relacionando com o sentido das concavidades do gráfico de
f , vem:
√
...
Logo, podemos concluir que o gráfico de f :
h √ √ i
• tem a concavidade voltada para baixo no i' },
    ...
    { id:'m12-23f1-4', num:'4', page:2, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'4.1. Para averiguar se a função g é contı́nua em x = 1, temos que verificar se g(1) = lim− g(x) = lim+ g(x)
x→1

x→1

• g(1) = 7 × 31−1 − 3 = 7 × 30 − 3 = 7 × 1 − 3 = 4

...
(considerando y = x − 1, temos x = y + 1 e se x → 1− , então y → 0− )
...
1' },
    ...
    { id:'m12-23f1-8', num:'8', page:5, tipo:'dev', tema:'probabilidades',
      ...
      resolucao:'Como a distância ao solo do foguete é dado por a(t), no instante t, a distância ao solo, 3 segundos depois
é dada por a(t + 3), pelo que a distância percorrida, durante os 3 segundos é dada por a(t + 3) − a(t).
Como se pretende que esta distância seja igual a 25 metros, o instante t em que se verifica a condição
dada é a solução da equação a(t + 3) − a(t) = 25 . 


x
Assim, inserindo na calculadora a função f (x) = 100 x + (10 − x) × ln 1 −
−4,9x2 , determinamos
10
o valor de t como a abcissa do ponto de interseção das funções:
• g(x) = f (x + 3) − f (x)
y

• h(x) = 25
Representando na calculadora as funções g e h, numa janela
compatı́vel com o domı́nio da função (x ∈ [0,5], porque
Df = [0,8], logo Df (x−3) = [0,5]), obtemos o gráfico representado na figura ao lado.
Recorrendo à função da calculadora para determinar valores aproximados das coordenadas dos ' },
...

f (x) − (2x − 1) = 0, a reta de equação y = 2x − 1 é uma

assı́ntota do gráfico de f , quando x tende para +∞, pelo que não existe uma assı́ntota horizontal do
gráfico de f , quando x tende para +∞, ou seja, a afirmação I. é falsa;
• como a reta de equação y = 2x − 1 é tangente ao gráfico de g no ponto de abcissa 1, então o ponto
da reta de coordenadas (1,2(1) − 1) = (1,1) também é um ponto do gráfico de g, ou seja, g(1) = 1; e
como a função g é diferenciável, também é contı́nua, em particular no ponto de abcissa 1, pelo que
lim g(x) = g(1) = 1, logo, a afirmação II. é falsa;
x→1

• como o gráfico de f tem a concavidade voltada para cima, f ′′ (x) > 0 e como o gráfico de g tem a
concavidade voltada para baixo, g ′′ (x) < 0, pelo que f ′′ (x) > g ′′ (x) para x > 0, pelo que a afirmação
III. tam' },
    ...
    { id:'m12-23f1-10', num:'10', page:5, tipo:'dev', tema:'integrais',
      ...
      resolucao:'Como Im (z) = Re (z), e Re (z) > 0, então o afixo de z é um ponto do primeiro quadrante que pertence à
π
bissetriz dos quadrante ı́mpares, ou seja, Arg (z) =
4
5π
π 5π
2π 5π
...
11. Escrevendo ei( 6 ) na forma algébrica, temos:
5π
...
Como i17 = i4×4+1 = i1 = i, simplificando a expressão do número w, vem:
√
...
2
2
Escrevendo w na forma trigonométrica (ρeiθ ), vem que:
v
u
r
√ !2 r
...
= − 3; como sen θ > 0 e cos ' },
    ...
    { id:'m12-23f1-13', num:'13', page:7, tipo:'dev', tema:'complexos',
      ...
      resolucao:'Como o declive da reta tangente ao gráfico de f , é dado por f ′ (x), começamos por derivar a função f :

f ′ (x) = ax2 + bx = 2ax + b
Como sabemos que o declive da reta tangente é a, a abcissa do ponto de tangência é a solução da equação
f ′ (x) = a, e desta forma temos:
f ′ (x) = a ⇔ 2ax + b = a ⇔ 2ax = a − b ⇔ x =

a−b
2a

Assim, podemos determinar a ordenada do ponto de tangência:
• através da equação da reta tangente:


a−b
a − b 2b
...
2
2
• através da expressão algébrica da função f :

f
...
Desta forma, igualando as duas expressões da ordenada do ponto de tangência, temos:
a+b
a2 − b2
4a
(a − b)(a + b)
...
'23_f2': {
  ...
  questoes: [
    { id:'m12-23f2-1', num:'1', page:2, tipo:'dev', tema:'geometria',
      ...
      resolucao:'Calculando os valores dos limites das sucessões, temos que:

n

n
...
Resposta: Opção D' },
    ...
    { id:'m12-23f2-2', num:'2', page:2, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'Para cada triângulo da sequência (à exceção do primeiro), o comprimento dos lados é metade do comprimento dos lados do triângulo do termo anterior da sequência. Assim, também o perı́metro de cada
triângulo (Pn ) é metade do perı́metro do triângulo anterior da sequência Pn−1 , ou seja:
Pn =
...
Ou seja, a sucessão dos perı́metros (Pn ) é uma progressão geométrica de razão

1
, e cujo o primeiro termo
2

é P1 = 3 × AB = 3 × 1 = 3.
Assim, a soma dos perı́metros dos n triângulos da sequência, é:
 n
 n
1
1
...
> 0, então 6 ×
> 0, pelo que 6 − 6 ×
< 6, ou seja, a soma dos
Como, para n ∈ N,
2
2
2
perı́metros dos n triângulos da sequência é inferior a 6.
...


• Como A e B são equiprováveis P (B) = P (A) = 0,4 e P B = P A = 0,6;





• P A ∪ B = P (A) + P B − P A ∩ B ⇔ 0,7 = 0,4 + 0,6 − P A ∩ B ⇔ P A ∩ B = 1 − 0,7 ⇔

⇔ P A ∩ B = 0,3

• P A ∩ B = P (A) − P (A ∩ B) ⇔ 0,3 = 0,4 − P (A ∩ B) ⇔ P (A ∩ B) = 0,4 − 0,3 ⇔ P (A ∩ B) = 0,1

 
E assim, o valor de P A ∪ B |B , na forma de fração irredutı́vel, é:
...
4' },
    ...
    { id:'m12-23f2-6', num:'6', page:3, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'Substituindo as coordenadas dos pontos na expressão algébrica da função, temos que:
• f (1) = 5 ⇔ a + eb×1 = 5 ⇔ a = 5 − eb
• f (2) = 7 ⇔ a + eb×2 = 7 ⇔ a = 7 − e2b
Ou seja:
5 − eb = 7 − e2b ⇔ e2b − eb − 2 = 0 ⇔ eb
...
• a = 5 − eb = 5 − 2 = 3' },
    ...
    { id:'m12-23f2-9', num:'9', page:5, tipo:'dev', tema:'integrais',
      ...
      resolucao:'Designado por d a abcissa do ponto D, ou seja, OD = d, temos que:
• D(d,0)

 
 
...
16
7
Como o ponto D pertence ao semieixo positivo Ox, então d > 0, ou seja d = 4.
⇔ −
...
5/8' },
    ...
    { id:'m12-23f2-10', num:'10', page:6, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'Temos que:
• pela observação do referencial I, podemos concluir que lim− g(x) < 0, e como a função é diferenciável,
x→0

então é contı́nua, em particular em x = 0, logo lim g(x) = lim g(x) = g(0), pelo que g(0) > 0 o
x→0+

x→0−

que é incompatı́vel com a segunda condição definida (g(0) < 0) pelo que no referencial I não está
representado parte do gráfico da função g;
• pela observação do referencial II, podemos concluir que a função é crescente no intervalo ] − ∞, −
1[, ou seja, g ′ (x) > 0, ∀x ∈] − ∞, − 1[ o que é incompatı́vel com a terceira condição definida
(g ′ (x) < 0, ∀x ∈] − ∞, − 1[) pelo que no referencial II não está representado parte do gráfico da
função g;
• pela observação do referencial III, podemos concluir que lim g(x) = −∞, e como a função é
x→−1+

par, então lim− g(x) =
x→1

lim + g(x) = −∞, o que é incompatı́vel com a primeira condi' },
    ...
    { id:'m12-23f2-12', num:'12', page:6, tipo:'dev', tema:'probabilidades',
      ...
      resolucao:'Observando que:
√
• podemos escrever −1 − 3i na forma trigonométrica (ρeiθ ):
q
√
√ 2 √
√
...
− 3
◦ tg θ =
= 3; como sen θ < 0 e cos θ < 0, θ é um ângulo do 3º quadrante, logo
−1
4π
π
θ=π+ =
...
4π
Pelo que −1 − 3i = 2ei( 3 ) ;
• como i11 = i4×2+3 = i3 = −i, então 2i11 = 2(−i) = −2i = 2ei( 2 ) .
3π

Assim, simplificando a expressão de z, temos que:
3π
4π
9π
8π
...
7π
Como Re z = − Im z, e o afixo de z pertence ao 4.º quadrante, então Arg z =
+ 2kπ, k ∈ Z, ou seja,
4
para k ∈ Z:
π
...
12
19π
Como α ∈ [0,2π[, então α =
.
12

6/8

13. Como p(j) é o valor da prestação mensal a pagar, em função da taxa de juro anual aplicada,j, a duplicação
da t' }
  ]
},
...
'23_esp': {
  ...
  questoes: [
    { id:'m12-23esp-1', num:'1', page:2, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'Analisando a monotonia de cada uma das sucessões, temos:
• an = (n − 5)2 : Como a4 = 1; a5 = 0 e a6 = 1, temos que a4 > a5 e a5 < a6 , então a sucessão não é
monótona;
(−1)n
1
1
1
• bn =
: Como a1 = − ; a2 = e a3 = − , temos que a1 < a2 e a2 > a3 , então a sucessão não
n+3
4
5
6
é monótona;
• cn = (−2)n : Como a1 = −2; a2 = 4 e a3 = −8, temos que a1 < a2 e a2 > a3 , então a sucessão não é
monótona;
1
• dn = :
n
...
n +n
n +n
Como n ∈ N, então n2 + n > 0,logo dn+1 − dn < 0,∀n ∈ N, ou seja, a sucessão é monótona (decrescente).
Resposta: Opção D' },
    ...
    { id:'m12-23esp-2', num:'2', page:2, tipo:'dev', tema:'geometria',
      ...
      resolucao:'Temos que:
• sequência dos raios das semicircunferências: rn = 2n−1 ;
• sequência dos comprimentos das semicircunferências (semiperı́meros das circunferências):
cn =
...
Como os termos da sequência dos comprimentos das semicircunferências é uma progressão geométrica de
razão 2, e cujo primeiro termo é c1 = π × 20 = π, então o comprimento total das 25 semicircunferências é
a soma dos 25 primeiros termos da sequência:
S25 = π ×

1 − 225
= π × 33 554 431 ≈ 1,0541 × 108 cm ≈ 1054 km
1−2
...
' },
    ...
    { id:'m12-23esp-6', num:'6', page:4, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'Designando por P o ponto pertencente ao segmento de reta [AB] com ordenada igual à do ponto C, temos
que [CP ] é a altura do triângulo [ABC], relativamente à base [AB], e assim, vem que:
• AB = tg α
• tg 2 α+1 =
...
E assim, a área do triângulo [ABC], é:
√
2
√
2
...
4/8' },
    ...
    { id:'m12-23esp-7', num:'7', page:4, tipo:'dev', tema:'integrais',
      ...
      resolucao:'7.1. Como o domı́nio de f é R\\{0}, para que exista lim f (x), então tem que se verificar lim+ f (x) = lim− f (x)
x→0
...
(considerando y = ax, temos que se x → 0− , então y → 0− , porque a > 0)
...
7.2. Como o gráfico de f , admite uma assı́ntota obl' },
    ...
    { id:'m12-23esp-9', num:'9', page:5, tipo:'dev', tema:'sucessoes',
      ...
      resolucao:'9.1. Começamos por determinar a expressão da derivada da função g:
′

g ′ (x) = (ex cos x) = (ex )′ × cos x + e2 × (cos x)′ = ex cos xex (− sen x) = ex (cos x − sen x)
Calculando os zeros da derivada da função g, temos:
g ′ (x) = 0 ⇔ ex (cos x − sen x) = 0 ⇔
...
Assim, como o domı́nio de g é [0,π[, a única solução da equação é x =

π
,(k = 0).
4

Estudando a variação do sinal da derivada e relacionando com a monotonia da função, vem:
π
4
...
Assim, podemos concluir que a função f :
h πi
• é cresce' },
    ...
    { id:'m12-23esp-10', num:'10', page:5, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'Como ex > 0 e e−x > 0, então ex + e−x ̸= 0,∀x ∈ R, pelo que resolvendo a equação, temos:

1
ex − e−x
=
...
P' },
    ...
    { id:'m12-23esp-11', num:'11', page:5, tipo:'dev', tema:'trigonometria',
      ...
      resolucao:'Observando que a diferença entre a distância máxima e a distância
mı́nima corresponde ao diâmetro, a, da circunferência, temos que:
√
√
√
√
a = 3 2 + 3 − (3 2 − 3) = 3 2 + 3 − 3 2 + 3 = 3 + 3 = 6
...
Assim, os dois instantes em que a distância do ponto P à reta r é
igual ao diâmetro da circunferência, são as soluções da equação
r
...
na calculadora gráfica o gráfico
√
3 2
da função f (x) =
(2+ sen x−cos x), e a reta horizontal
2
de equação y = 6, para 0 < x < 7, reproduzido na figura ao
lado, e usando a função da calculadora para determinar valores aproximados das coordenadas do ponto de interseção
de dois gráficos, obtemos o valor aproximado (às décimas)
das abcissas dos pontos de interseção, a que correspondem
os dois instantes em que a distância do ponto P à reta r é
igual ao diâmetro da circunferên' },
...
π
π
, considerando ρ = |z|, temos que z = ρei 7 .
7

π

Como 2i = 2ei 2 , então:
2iz = 2i × z = 2ei 2 × ρei 7 = 2ρei( 2 + 7 ) = 2ρei( 14 + 14 ) = 2ρei 14
π
...
13. Escrevendo z2 na forma trigonométrica (ρeiθ ) temos:
q
√
√
√
...
4π
• tg θ =
= 3; como sen θ < 0 e cos θ < 0, θ é um ângulo do 3º quadrante, logo θ = π + =
−1
3
3
4π
...
Logo z2 = 2ei 3 .
Como i23 = i4×5+3 = i3 = −i, escrevendo z1 + i23 na forma trigonométrica, vem:
3π

z1 + i23 = −5i − i = −6i = 6ei 2
Assim, simplificando a expressão de w, temos que:
3π

w=

Como w é um imaginário puro se Arg w =
Arg w =
...
'22_f1': {
  ...
  questoes: [
    { id:'m12-22f1-1', num:'1', page:2, tipo:'dev', tema:'sucessoes',
      ...
      resolucao:'Para cada uma das expressões apresentadas, considerando que
• se n é par, então (−1)n = 1 ;
• se n é ı́mpar, então (−1)n = −1 ;
temos que:
• (−1)n × n não representa uma sucessão convergente porque:
n par: lim ((−1)n × n) = lim n = +∞
n ı́mpar: lim ((−1)n × n) = lim(−n) = −∞
•

(−1)n
representa uma sucessão convergente porque:
n


(−1)n
...
• (−1)n + n não representa uma sucessão convergente porque:
n par: lim ((−1)n + n) = lim n = +∞
n ı́mpar: lim ((−1)n + n) = lim(−1 + n) = +∞
• (−1)n − n não representa uma sucessão convergente porque:
n par: lim ((−1)n − n) = lim(1 − n) = −∞
n ı́mpar: lim ((−1)n − n) = lim(−1 − n) = −∞
Resposta: Opção B' },
    ...
    { id:'m12-22f1-2', num:'2', page:2, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'Como a soma dos 5 primeiro termos da progressão geométrica é 211 e a razão é
termo (u1 ), temos:

2
, calculando o primeiro
3
...
2/9' },
    ...
    { id:'m12-22f1-4', num:'4', page:3, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'Se as duas peças a colocar no tabuleiro foram da mesma cor, interessa selecionar 2 das 12 posições do
tabuleiro, sem considerar a ordem relevante (12 C2 ) porque as peças a colocar são iguais, e o número de
seleções possı́veis deve ser multiplicado por 3 porque existem 3 cores para as peças a colocar (verdes,
amarelas e encarnadas). Ou seja, o número de formas diferentes de dispor duas peças da mesma cor no
tabuleiro é:
3 ×12 C2
Se as duas pelas foram de cores distintas, interessa selecionar 2 das 3 cores disponı́veis (3 C2 ), e para cada
um destes pares de cores, escolher 2 das 12 posições do tabuleiro, considerando a ordem relevante (12 A2 )
porque as peças a colocar são diferentes. Ou seja, o número de formas diferentes de dispor duas peças
decor diferentes no tabuleiro é:
3
C2 ×12 A2
Como é possı́vel, em alternativa, obter qualquer um destes dois tipos de configur' },
    ...
    { id:'m12-22f1-5', num:'5', page:3, tipo:'dev', tema:'geometria',
      ...
      resolucao:'Considerando a experiência aleatória que consiste em escolher, ao acaso, um aluno da que participou no
torneio de jogos matemáticos, e os acontecimentos:
S:≪O aluno jogo Semáforo≫
R:≪O aluno jogou Rastros≫
Temos que P (S) =
...
Assim, a probabilidade de um aluno que participou no torneio escolhido, ao acaso, não ter jogado Semáforo
e ter jogado Rastros, na forma de fração irredutı́vel, é:

3
9
3
...
6.' },
    ...
    { id:'m12-22f1-7', num:'7', page:4, tipo:'dev', tema:'integrais',
      ...
      resolucao:'Como a circunferência tem raio 3, o respetivo perı́metro é 2 × π × 3 = 6π
Assim, o comprimento do arco AB é 2π, a amplitude do ângulo ACB é:
2π
2π × 2π
4π
2π
...
6
3
Desta forma, como ambos os vetores têm norma 3, recorrendo à fórmula do produto escalar, vem:
 
−−→ −−→
−−→
−→
...
8.' },
    ...
    { id:'m12-22f1-8', num:'8', page:2, tipo:'dev', tema:'logaritmos',
      ...
      resolucao:'8.1. Para averiguar se a função f é contı́nua em x = 2, temos que verificar se f (2) = lim f (x) = lim f (x)
x→2−
...
(considerando y = x − 2, temos x = y + 2 e se x → 2− , então y → 0− )
...
função' },
    ...
    { id:'m12-22f1-10', num:'10', page:5, tipo:'dev', tema:'complexos',
      ...
      resolucao:'Como Im (w) = − Re (w), então w é um número complexo da forma ρei(− 4 ) e como Re (w) > 1, então
ρ>1
π

Assim, como −i = ei( 2 ) temos que:
3π
...
π
3π
−iw2 = ei( 2 ) × ρei(− 4 ) = eiπ ×ρei(− 4 ) ×ρei(− 4 ) = (1×ρ×ρ)ei( 2 +(− 4 )+(− 4 )) = ρ2 ei( 2 − 2 ) = ρ2 eiπ
Como ρ > 1 então ρ2 > ρ, então o afixo de iw2 deve estar a uma distância da origem superior ao afixo de
w, e como o afixo pertence ao semieixo real positivo (porque Arg (−iw2 ) = π), o ponto C é o único que
pode representar o afixo de −iw2 .
Resposta: Opção C
...
'22_f2': {
  ...
  questoes: [
    { id:'m12-22f2-1', num:'1', page:2, tipo:'dev', tema:'geometria',
      ...
      resolucao:'De entre as opções apresentadas, a única que representa o gráfico de uma função com um mı́nimo em
x = 0 é a opção (C), porque nas restantes opções existem valores de a, pertencentes ao domı́nio da função,
tais que f (a) > f (0)
Resposta: Opção C' },
    ...
    { id:'m12-22f2-4', num:'4', page:2, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'Calculando o número de grupos ordenados dos 3 cartões azuis, temos 3 A3 = P3 = 3! hipóteses para dispor
os 3 cartões azuis em posições adjacentes.
E por cada grupo de cartões azuis, existem 10 A10 = P10 = 10! ordenações possı́veis dos 12 cartões,
correspondendo à disposição dos 9 cartões de outras cores e do grupo de cartões azuis, considerando a
ordenação relevante.
Assim, o número casos favoráveis (disposições com os cartões azuis em posições adjacentes) é 3! × 10! e o
número de casos possı́veis (todas as disposições dos 12 cartões) é 12 A12 = P12 = 12!, pelo que, recorrendo
à Regra de Laplace, calculando a probabilidade de de os cartões azuis ficarem todos juntos, na forma de
fração irredutı́vel, é:
1
3! × 10!
=
p=
...
5.' },
    ...
    { id:'m12-22f2-7', num:'7', page:4, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'Como i18 = i4×4+2 = i2 = −1, temos que:
z=
...
Escrevendo z na forma trigonométrica (ρeiθ ) temos:
p
√
√
• ρ = (−2)2 + 22 = 4 + 4 = 8
...
3π
• tg θ =
= −1; como sen θ > 0 e cos θ < 0, θ é um ângulo do 2.º quadrante, logo θ = π − =
−2
4
4
√ i( 3π )
Assim temos que z = 8e 4 , e como os argumentos das três raı́zes cúbicas de um mesmo número
2π
complexo diferem de
, e os respetivos módulos são iguais, temos que as restantes raı́zes cúbicas de w,
3
são:
√
√
...
24π
π
• z = 8ei( 12 + 3 ) = 8ei( 12 + 12 ) = 8ei( 12 ) = 8ei( 12 −2π) = 8ei( 12 − 12 ) = 8ei( 12 )
3' },

    { id:'m12-22f2-8', num:'8', page:4, tipo:'dev', tema:'integrais',
      enun:'Calcule o integral definido ou determine a área da região pedida.',
      resolucao:'Para averiguar se a função f é contı́nua em x = 0, temos que verificar se f (0) = lim f (x) = lim f (x)
x→0−
...
Como f (0) ̸= lim− f (x), então a função f não é contı́nua em x = 0 .
x→0
...
9.' },
    ...
    { id:'m12-22f2-9', num:'9', page:2, tipo:'dev', tema:'limites',
      ...
      resolucao:'9.1. Para estudar o sentido o sentido das concavidades e a existência de pontos de inflexão, começamos
por determinar a expressão da segunda derivada no intervalo ]0,π[ :
g ′′ (x) = g ′ (x)
...
= (x)′ + 2(cos x cos x)′ = 1 + 2((cos x)′ cos x + cos x(cos x)′ ) =
...
'22_esp': {
  ...
  questoes: [
    { id:'m12-22esp-1', num:'1', page:2, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'1.1. Como o vértice A pertence ao semieixo positivo Ox e o vértice F pertence ao semieixo positivo Oy,
então a base [ABCDEF ] do prisma pertence ao plano xOy.
Como o prisma hexagonal [ABCDEF GHIJKL] é reto, a base [GHIJKL] é paralela ao plano xOy,
o seja o plano que contem esta face é definido por uma equação da forma z = k, k ∈ R
Como o ponto M , equidistante de ambas as bases tem de cota 2, então a altura do prima é 2 × 2 = 4,
ou seja, a equação do plano que contém a face [GHIJKL] é z = 4
Resposta: Opção B
...
2/10' },
    ...
    { id:'m12-22esp-2', num:'2', page:2, tipo:'dev', tema:'geometria',
      ...
      resolucao:'Como qualquer triângulo inscrito numa semicircunferência é retângulo, temos
que a medida da hipotenusa do triângulo é AC = 4, e recorrendo às definições
...
Como o raio da circunferência é metade do respetivo diâmetro, r =
região é a diferença da área do semicı́rculo e da área do triângulo:
A=
...
2
2
= 2π − 4 × 2 sen α cos α = 2π − 4 sen (2α)' },
    ...
    { id:'m12-22esp-4', num:'4', page:3, tipo:'dev', tema:'probabilidades',
      ...
      resolucao:'Determinando a probabilidade com recurso à regra de LaPlace, calculamos o quociente do número de
casos favoráveis pelo número de casos possı́veis, sendo os casos possı́veis equiprováveis.
Como a empresa tem 60 funcionários, o número de grupos de 4 funcionários que podem ser formados, sem
sequência ou hierarquia, ou seja, o número de casos possı́veis é 60 C4 .
O número de funcionários que trabalham em regime presencial corresponde a 75% do total de trabalhadores (sendo excluı́dos os 25% que trabalham exclusivamente a distância), ou seja 0,75 × 60 = 45 .
Como se pretende calcular a probabilidade de serem selecionados, no máximo, três funcionários que trabalham em regime presencial, podemos calcular o número de casos favoráveis pela diferença de todos os
grupos que se podem constituir e o número de grupos que é constituı́do exclusivamente pelos funcionários
que trabal' },
    ...
    { id:'m12-22esp-7', num:'7', page:4, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'De acordo com o enunciado, e com a definição de progressão aritmética, temos que:
• v3 = 1 ⇔ v1 + 2r = 1 ⇔ v1 = 1 − 2r
• v10 = v1 + 9r = 1 − 2r + 9r = 1 + 7r
• v9 = v1 + 8r = 1 − 2r + 8r = 1 + 6r
Desta forma, vem que a razão é:
v10 =
...

1
E o primeiro termo é: v1 = 1 − 2r = 1 − 2 −
=1+1=2
2
1
Assim o termo geral da sucessão é: vn = 2 − (n − 1)
2
Desta forma, resolvendo a equação vn = −50, vem:
1
n 1
n
1
...
⇔ n = 105
2
Como a solução da equação é um número natural, então −50 é o termo de ordem 105 da sucessão (vn ),
ou seja, v105 = −50
⇔ n=2×
...
5/10' },
    ...
    { id:'m12-22esp-9', num:'9', page:5, tipo:'dev', tema:'integrais',
      ...
      resolucao:'Simplificando a expressão de z1 , como i7 = i4+3 = i3 = −i, temos que:
z1 = (1 + i)2 × (2 + i) + i7 = (1 + 2i + i2 ) × (2 + i) − i = 2i × (2 + i) − i =
= (1 + 2i − 1) × (2 + i) − i = 2i(2 + i) − i = 4i + 2i2 − i = 3i + 2(−1) = −2 + 3i
Assim, podemos determinar o valor de z2 :
z1 ×z2 = 3+2i ⇔ z2 =
...
z2 = sen θ + i cos θ ⇔ sen θ + i cos θ = −i ⇔ sen θ + i cos θ = 0 − i
Ou seja sen θ = 0 ∧ cos θ = −1, pelo que θ = π' }
  ]
},
...
'21_f1': {
  ...
  questoes: [
    ...
    { id:'m12-21f1-2', num:'2', page:2, tipo:'dev', tema:'probabilidades',
      ...
      resolucao:'Como a circunferência tem raio 3 e está centrada na origem,
as coordenadas do ponto A são da forma (3 cos α,3 sen α) e
como [AB] é um diâmetro da circunferência as coordenadas do
ponto B são da forma (3 cos(α + π),3 sen (α + π) .
Assim, considerando o lado [BC] como a base do triângulo,
temos que a altura é 2 × OC, porque a abcissa do ponto A é
simétrica da abcissa dos pontos B e C
...
Como α é um ângulo do segundo quadrante, então:
• sen α > 0 e sen (α + π) < 0, pelo que:
...
• cos α < 0 e cos(α + π) > 0, pelo que:
OC = |3 cos(α + π)| = −|3 cos α| = −3 cos α
Assim, temos que a área do triângulo é:
A[ABC] =

BC × 2 × OC
= 3 sen α × (−3 cos α) = −9 sen α cos α
2
...
3/9' },
    ...
    { id:'m12-21f1-3', num:'3', page:3, tipo:'dev', tema:'funcoes',
      enun:'Estude a função apresentada quanto à continuidade, monotonia, extremos e assíntotas.',
      resolucao:'Considerando a experiência aleatória que consiste em escolher, ao acaso, um aluno da escola, e os acontecimentos:
P t:O estudante ser português
R:O estudante ser um rapaz


Temos que P R = 60% e P R ∩ P t = 15%
Assim, organizando os dados numa tabela obtemos:

• P (R) = 100 − P R = 100% − 60% = 40%
• P (P t ∩ R) = 40% − 15% = 25%
...
Assim, a probabilidade de um aluno da escola escolhido, ao acaso,
ser português sabendo que era um rapaz, na forma de percentagem,
é 62,5%, porque:
P (P t|R) =
...
Resposta: Opção D' },
    ...
    { id:'m12-21f1-4', num:'4', page:3, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'Como os dois condutores são dois dos três dirigentes,existem 3 A2 formas diferentes de selecionar os condutores (a ordem é relevante, porque as viaturas são diferentes).
Como no automóvel, vão dois jogadores de cada sexo, não existe qualquer lugar disponı́vel para o treinador
ou para o dirigente que não vai conduzir, pelo que o número de formas diferentes de selecionar os restantes
ocupantes do automóvel consiste em contar o número de formas de selecionar 2 dos 5 jogadores do sexo
masculino e 2 das 5 jogadoras do sexo feminino, ou seja, 5 C2 ×5 C2
Assim, temos a contagem do número de condutores e grupos de ocupantes de cada uma das viaturas,
pelo que resta ainda ordenar os 4 ocupantes do automóvel e 8 ocupantes da carrinha (à exceção dos condutores) pelos lugares disponı́veis em cada viatura, ou seja P4 = 4 A4 = 4! para os lugares do automóvel e
P8 = 8 A8 = 8! para os lu' },

    { id:'m12-21f1-5', num:'5', page:3, tipo:'dev', tema:'integrais',
      enun:'Calcule o integral definido ou determine a primitiva.',
      resolucao:'Como existem 30 alunos na turma e se pretende escolher ao acaso, 5 alunos da turma,o número de grupos
diferentes que é possı́vel escolher (sem considerar a ordem relevante), é 30 C5
Temos ainda que:
• O grupo deve integrar o André e a Beatriz que têm ambos 16 anos.
• 60% dos alunos são raparigas, ou seja, 30 × 0,6 = 18 raparigas, e 30 − 18 = 12 rapazes.
12
= 4 rapazes, e existem 12 − 4 = 8 rapazes
• Um terço dos rapazes tem 17 anos a que corresponde
3
com 15 ou 16 anos.
18
• Um terço das raparigas tem 15 ou 16 anos a que corresponde
= 6 raparigas, e existem 18 − 6 = 12
3
raparigas com 17 anos.
Assim, como o grupo deve ser constituı́do por dois jovens com 17 anos, e existem 4 rapazes e 12 raparigas,
ou seja, 12 − 4 = 16 no total, existem 16 C2 grupos distintos de 2 alunos com 17 anos.
Relativamente ao aluno de 15 ou 16 que deve integrar o grupo, podemos verificar que existem 8 rap' },
    ...
    { id:'m12-21f1-9', num:'9', page:5, tipo:'dev', tema:'logaritmos',
      ...
      resolucao:'Calculando o produto z1 × z2 , vem:
z1 × z2 = (−3 + 2i) × (1 + 2i) = −3 − 6i + 2i + 4i2 = −3 − 4i + 4(−1) = −3 − 4 − 4i = −7 − 4i
Simplificando a expressão de w, temos:
w=
...
Desta forma, considerando θ = Arg (w) temos que:
p
√
√
• |w| = (−2)2 + (−3)2 = 4 + 9 = 13
...
3
• tg θ =
= ; como sen θ < 0 e cos θ < 0, θ é um ângulo do 3º quadrante.
−2 2 


3π
...
3
3π
= 1, a função tangente é crescente e contı́nua no intervalo − , −
e >1
• Como tg −
4
4
...
π
3π
• Como θ é um ângulo do 3º quadrante e θ > − , então Arg (w) ∈ − , −
4
4
2
...
10.' },
    ...
    { id:'m12-21f1-10', num:'10', page:2, tipo:'dev', tema:'trigonometria',
      ...
      resolucao:'10.1. Para averiguar se a função f é contı́nua em x = 1, temos que verificar se f (1) = lim− f (x) = lim+ f (x)
x→1

x→1

• f (1) = −12 (1 + 2 ln 1) = −(1 + 2 × 0) = −1

...
x→1
x→1
(como x2 + 3x − 4 = 0 ⇔ x = 1 ∨ x = −4 então x2 + 3x − 4 = (x − 1)(x + 4))
...
'21_f2': {
  ...
  questoes: [
    ...
    { id:'m12-21f2-12', num:'1.2', page:2, tipo:'dev', tema:'geometria',
      ...
      resolucao:'Como [P QRS] é um trapézio de bases [P Q] e [RS], as retas P Q e RS são
paralelas. Assim, o plano perpendicular à reta RS também é perpendicular à
−−→
reta P Q, pelo que o vetor P Q é um vetor normal do plano pretendido.
−−→
...
Logo a equação do plano é da forma:
−3x + 2y − z + d = 0
E como o ponto P pertence ao plano, podemos determinar o valor do parâmetro d, substituindo as
coordenadas, na equação anterior:
−3(1) + 2(−1) − (2) + d = 0 ⇔ −3 − 2 − 2 + d = 0 ⇔ −7 + d = 0 ⇔ d = 7
E assim, a equação do plano perpendicular à reta RS e que contém o ponto P , é:
−3x + 2y − z + 7 = 0
...
i πh' },
    ...
    { id:'m12-21f2-2', num:'2', page:2, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'Representando no cı́rculo trigonométrico um ângulo de amplitude α ∈ 0, ,
2
1
tal que, sen α = − (como na figura ao lado), podemos verificar que
5



...
E, pela fórmula fundamental da trigonometria, vem:
...
2
i πh
Representando no cı́rculo trigonométrico um ângulo de amplitude α ∈ 0, ,
2
1
tal que, cos α = (como na figura ao la' },
    ...
    { id:'m12-21f2-4', num:'4', page:3, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'Como os pontos pertencem a duas retas, os 5 pontos da reta r são colineares, pelo que nenhum conjunto
de 3 destes pontos define um triângulo, assim como acontece para os n pontos da reta s.
Desta forma, para definir um triângulo com 3 destes pontos é necessário selecionar 2 pontos da reta
r e 1 ponto da reta r (5 C2 ×n C1 triângulos distintos deste tipo), ou em alternativa, selecionar 1 ponto da
reta r e 2 pontos da reta r (5 C1 ×n C2 triângulos distintos deste tipo).
Como é possı́vel definir exatamente 175 triângulos, temos que:
5

C2 ×n C1 +5 C1 ×n C2 = 175

Resolvendo a equação anterior, determinamos o valor de n:
5
...
20n (n2 − n) × 5
+
= 175 ⇔ 20n + 5n2 − 5n = 350 ⇔ 5n2 + 15n − 350 = 0 ⇔ n = 7 ∨ ' },
    ...
    { id:'m12-21f2-6', num:'6', page:4, tipo:'dev', tema:'integrais',
      ...
      resolucao:'De acordo com o enunciado temos que:
• u6 + u20 = −5
• u19 = 4 × u7
Assim, resolvendo o sistema seguinte, usando a expressão to termo geral de uma progressão aritmética
(un = u1 + r(n − 1)), determinamos o valor do primeiro termo (u1 ) e da razão (r) da progressão:




...
u1 = ' },
    ...
    { id:'m12-21f2-8', num:'8', page:5, tipo:'dev', tema:'logaritmos',
      ...
      resolucao:'Considerando cada pontos do plano complexo na forma z = x + yi, temos que os pontos da reta são da
forma:
(1 + 2i)(x + yi) + (1 − 2i)(x − yi) + 10 = 0 ⇔ x + yi + 2xi + 2yi2 + x − yi − 2xi + 2yi2 + 10 = 0 ⇔
⇔ 2x + 2y(−1) + 2y(−1) + 10 = 0 ⇔ 2x − 2y − 2y + 10 = 0 ⇔ 2x − 4y + 10 = 0 ⇔ x − 2y + 5 = 0 ⇔
⇔ x + 5 = 2y ⇔
...
Assim, de todos os números complexos cujos afixos pertencem
a esta reta, o que tem menor módulo, ou seja, o que está mais
próximo da origem do plano complexo, é o ponto de tangência
da circunferência tangente à reta e que passa na origem, ou
seja a interseção com a reta perpendicular à dada que contém
a origem.

Im(z)

Relativamente à reta perpendicular, sabemos que o declive é o simétrico do inverso do declive da reta dada e que a
ordenada na origem é nula (porque contém a origem), ou seja,
é definida por:
y=−
...
' },
    ...
    { id:'m12-21f2-9', num:'9', page:2, tipo:'dev', tema:'probabilidades',
      ...
      resolucao:'9.1. Como o domı́nio da função é R, podem existir assı́ntotas horizontais do gráfico de f quando x → −∞
e quando x → +∞:
•
...
(fazendo y = −x, temos x = −y e se x → −∞, então y → +∞)
...
+' },
    ...
    { id:'m12-21f2-10', num:'10', page:5, tipo:'dev', tema:'sucessoes',
      ...
      resolucao:'Começamos por determinar a expressão da derivada da função h:
0
0
0
...
h πh
Calculando os zeros da derivada, no domı́nio da função ( 0, ), vem:
2
...
Como x ∈ 0, , temos:
2
• cos x > 0, pelo que cos x = 0 é uma condição impossı́vel
1
π
• sen x =
⇒x=
...
6
h πh
Assim, temos que h0 (x) tem um zero em 0,
e estudando a variação do sinal da derivada e relacionando
2
com a monotonia da função, vem:
π
6
...
Assim, podemos concluir que a função h:


• é crescente' },
...
'21_esp': {
  ...
  questoes: [
    ...
    { id:'m12-21esp-2', num:'2', page:3, tipo:'dev', tema:'trigonometria',
      ...
      resolucao:'Considerando α como a amplitude do ângulo AOP , temos que as coordenadas do ponto P são:
P (r cos α,r sen α)
...
= r(1 − cos α + 1 − sen α) = r(2 − sen α − cos α)
...
Como d o comprimento do arco AP , definido pelo ângulo α, e o perı́metro da circunferência é 2πr, correspondente a um ângulo de amplitude 2π radianos, então podemos identificar uma relação entre α, r e
d:
α
d
2π × d
...
r' },
    ...
    { id:'m12-21esp-3', num:'3', page:3, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'Observando que entre 0 e 10 existem 11 valores números inteiros (incluindo estes limites), então o número
de pontos cujas coordenadas são números inteiros, na região indicada, ou seja, o número de casos possı́veis,
é:
y

11 × 11 = 121
A reta de equação y = x + 7 contém 4 dos pontos com coordenadas

inteiras que pertencem a esta região (0,7); (1,8); (2,9) e (3,10) , o
seja, o número de casos favoráveis é 4.

10
7

Assim, recorrendo à Regra de Laplace, temos que o valor, arredondado às milésimas, da probabilidade de selecionar ao acaso um
dos pontos identificados e ele pertencer à reta dada, é:
4
≈ 0,033
121
...
Resposta: Opção B' },
    ...
    { id:'m12-21esp-4', num:'4', page:3, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'Se a Fernanda oferecer 3 dos 5 livros e 3 das 7 canetas a um dos netos, como a ordem de seleção não é
relevante e o beneficiário deste conjunto pode ser qualquer um dos dois netos o número de formas diferentes
de fazer a repartição é:
2 ×5 C3 ×7 C3
Se a alternativa for oferecer 4 dos 5 livros e 2 das 7 canetas a um dos netos, como a ordem de seleção
continua a não ser relevante e o beneficiário deste conjunto também pode ser qualquer um dos dois netos
o número de formas diferentes de fazer a repartição é:
2 ×5 C4 ×7 C2
Como as qualquer uma destas alternativas pode acontecer em alternativa, temos que o número de modos
diferentes pode a Fernanda repartir os doze objetos pelos seus dois netos é:
2 ×5 C3 ×7 C3 + 2 ×5 C4 ×7 C2 = 910
...
Desta forma, dos gráficos apresentados, o único que representa
uma função que pode verificar esta condição é o gráfico da
opção (A).
Resposta: Opção A' },

    { id:'m12-21esp-7', num:'7', page:5, tipo:'dev', tema:'sucessoes',
      enun:'Estude a sucessão apresentada: monotonia, limitação e limite.',
      resolucao:'Os termos de ordem ı́mpar da sucessão (un ) são aqueles cuja ordem é da forma 2k − 1 (k ∈ N), ou seja a
sucessão dos termos de ordem ı́mpar da sucessão (un ) é:
vk = 2(2k − 1) + 1 = 4k − 2 + 1 = 4k − 1
Ou seja, é uma progressão aritmética de razão 4, pelo que a soma dos 200 primeiros termos é:
S200 =
...
3
3
• (z2 ) = 2i = (−2i) = (−2)3 i3 = −8 × (−i) = 8i
1
8
3
• z1 2 × (z2 ) = i × 8i = i2 = 2 × (−1) = −2
4
4
Assim, temos que:
3

iz 2 + z1 2 × (z2 ) − 2 = 0 ⇔ iz 2 + (−2) − 2 = 0 ⇔ iz 2 − 4 = 0 ⇔ iz 2 = 4 ⇔ z 2 =
...
, k ∈ {0,1}
−1
Assim, os dois números complexos que são solução da equação, escritos na forma trigonométrica, são:
...
10.' },
    ...
    { id:'m12-21esp-10', num:'10', page:2, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'10.1. Como a função f é contı́nua em x = 1, temos que:
f (1) = lim+ f (x) = lim− f (x)
x→1
...
x→1
x→1
(fazendo y = x − 1, se x → 1, então y → 0, e observando que 1 − x2 = 12 − x2 = (1 − x)(1 + x) = −(x − 1)(x + 1))
...
'20_f1': {
  ...
  questoes: [
    ...
    { id:'m12-20f1-3', num:'3', page:2, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'3.1. Podemos observar que:
P (A ∩ B) =
...
E assim, designando por a o número de bolas azuis e por b o número de bolas brancas que existiam
inicialmente no saco, temos que o número de bolas brancas na segunda extração, sabendo que a
primeira bola extraı́da foi azul, é b e o número total de bolas é a − 1 + b
Assim, como a probabilidade de retirar uma bola branca na segunda extração, sabendo que foi
1
retirada uma bola azul na primeira extração, é , temos que:
3
P (B|A) =
...
a−1+' },
    ...
    { id:'m12-20f1-5', num:'5', page:2, tipo:'dev', tema:'geometria',
      ...
      resolucao:'5.1. Determinando as coordenadas dos pontos A e B, com recurso à equação que define o plano ABC,
temos:
• Como o ponto A pertence ao eixo Oy, tem abcissa e cota nulas, e assim, a sua ordenada é:
...
• Como o ponto B pertence ao eixo Ox, tem ordenada e cota nulas, e assim, a sua abcissa é:
3x + 4(0) + 4(0) − 12 = 0 ⇔ 3x + 0 + 0 = 12 ⇔ x =

12
⇔ x=4
3

Assim, as coordenadas dos pontos A e B são, respetivamente, (0,3,0) e (4,0,0) e a distância AB, ou
seja, a altura do cilindro, é:
p
p
√
√
AB = (4 − 0)2 + (0 − 3)2 + (0 − 0)2 = 42 −' },
...
'20_f2': {
  ...
  questoes: [
    { id:'m12-20f2-1', num:'1', page:2, tipo:'dev', tema:'geometria',
      ...
      resolucao:'1.1. Como o plano EF G é perpendicular à reta AE, o vetor diretor da reta (~v =
(3, − 6,2)) é um vetor normal do plano, assim a equação do plano é da forma:
3x − 6y + 2z + d = 0
~v
E como o ponto G pertence ao plano, podemos determinar o valor do parâmetro
d, substituindo as coordenadas, na equação anterior:
3(5) − 6(3) + 2(6) + d = 0 ⇔ 15 − 18 + 12 + d = 0 ⇔ 9 + d = 0 ⇔ d = −9
E assim, uma equação do plano EF G, é:
3x − 6y + 2z − 9 = 0
z' },
    ...
    { id:'m12-20f2-3', num:'3', page:2, tipo:'dev', tema:'funcoes',
      enun:'Estude a função f quanto à continuidade, monotonia, extremos e assíntotas.',
      resolucao:'De acordo com os acontecimentos A e B definidos, e os dados do enunciado, temos que:
• P (A) = 0,3
• P (B) = 0,4

• P A ∪ B = 0,9
Assim, usando as Leis de De Morgan, e o teorema do acontecimento contrário, temos que:


P A ∪ B = 0,9 ⇔ P A ∩ B = 0,9 ⇔ 1 − P (A ∩ B) = 0,9 ⇔
⇔ P (A ∩ B) = 1 − 0,9 ⇔ P (A ∩ B) = 0,1
E assim, podemos calcular P (A ∪ B):
P (A ∪ B) = P (A) + P (B) − P (A ∩ B) = 0,3 + 0,4 − 0,1 = 0,6
Como A ∩ (A ∪ B) = (A ∩ A) ∪ (A ∩ B) = A ∪ (A ∩ B) = A, porque
 (A ∩ B) ⊂ A, então, usando a definição
de probabilidade condicionada, podemos calcular P A|(A ∪ B) , e apresentar o resultado na forma de
fração irredutı́vel:
3


 P A ∩ (A ∪ B)
...
10' },
    ...
    { id:'m12-20f2-6', num:'6', page:3, tipo:'dev', tema:'derivadas',
      enun:'Estude a função apresentada quanto à monotonia, extremos e concavidades.',
      resolucao:'Como o sétimo termo da progressão aritmética é igual ao dobro do segundo, designado a razão por r,
temos que:
u7 = 2 × u2 ⇔ u1 + (7 − 1) × r = 2(u1 + r) ⇔ u1 + 6r = 2u1 + 2r ⇔ 6r − 2r = 2u1 − u1 ⇔ 4r = u1
Como a soma dos 12 primeiros termos é:
S12 =
...
Como a soma dos doze primeiros termos é 57, temos que:
S12 = 57 ⇔ 114r = 57 ⇔ r =
...
n−1
1
, pelo que a ordem do termo 500, é a solução da equação
Logo, u1 = 4r = 4 × = 2 e un = 2 +
2
2
un = 500:
un = 500 ⇔ 2 +
...
n−1
= 500 ⇔
= 500 − 2 ⇔ n − 1 = 498 × 2 ⇔ n = 996 + 1 :⇔ n = 997
2
2

Ou seja, a ordem do termo 500 é 997, isto é, u997 = 500


1' },
...
'20_esp': {
  ...
  questoes: [
    ...
    { id:'m12-20esp-2', num:'2', page:2, tipo:'dev', tema:'geometria',
      ...
      resolucao:'Como [M N P QRS] é um hexágono regular, pode ser dividido em
tiângulos equiláteros, pelo que o triângulo [OM N ] é equilátero, temos
180
que C M̂ N =
= 60◦ , e o ângulo definido pelo semi-eixo positivo Ox
3
e a reta M N é de 180 − 60 = 120◦ ou seja a inclinação da reta M N é
120◦ , e assim, o declive correspondente, mM N , é:
√
mM N = tg(120◦ ) = − tg(180 − 120◦ ) = − tg(60◦ ) = − 3
Assim, temos que a equação reduzida da reta M N é da forma:
√
y = − 3x + b
...
Como o ponto M (1,0) pertence à reta, podemos calcular o valor de b, substituindo as coordenadas do
ponto M na condição anterior:
√
√
0=− 3×1+b ⇔ 3=b
Pelo que a equação reduzida da reta M N é:
√
√
y = − 3x + 3
Resposta: Opção A
...
3/9' },
    ...
    { id:'m12-20esp-3', num:'3', page:2, tipo:'dev', tema:'probabilidades',
      enun:'Problema de probabilidade com distribuição condicional ou total.',
      resolucao:'Como o dado tem 6 faces e é lançado 4 vezes, a quantidade de números que podem ser obtidos, ou seja,
o número de casos possı́veis, é 6 A04 = 64
Para que o número formado seja uma capicua, o algarismo dos milhares deve ser igual ao das unidades e o algarismo das dezenas deverá ser igual ao das centenas. O algarismo dos milhares não pode ser 5
nem 6, para que o números seja inferior a 5000, e também não pode ser 1 nem 3, para que o algarismo das
unidades seja par, visto que devem ser iguais. Assim só existem 2 algarismos favoráveis para o primeiro
dı́gito, 6 para o segundo (porque não existem restrições), 1 para o terceiro (porque deve ser igual ao
segundo) e 1 para o quarto (porque deve ser igual ao primeiro) para que o algarismo seja uma capicua,
ou seja, o número de casos favoráveis é 2 × 6 × 1 × 1
Desta forma, a probabilidade é:
...
Resposta: Op' },
    ...
    { id:'m12-20esp-4', num:'4', page:3, tipo:'dev', tema:'derivadas',
      enun:'Estude a função f quanto à monotonia, extremos e concavidades.',
      resolucao:'4.1. Considerando a experiência aleatória que consiste em escolher, ao acaso, um dos hóspedes do hotel,
e os acontecimentos:
E:O hóspede ter participado na caminhada na serra da Estrela
Z:O hóspede ter participado ter participado na descida do rio Zêzere

Temos que P (E) = 0,8; P (Z) = 0,5 e P E|Z = 0,3
Assim, organizando os dados numa tabela obtemos:


• P E ∩ Z = P (Z) × P E|R = 0,5 × 0,3 = 0,15

• P (E ∩ Z) = P (Z) − P E ∩ Z = 0,5 − 0,15 = 0,35
...
Assim, a probabilidade do hóspede, selecionado ao acaso, ter participado na caminhada na serra
da Estrela e não ter participado na descida do rio Zêzere, na forma de percentagem, é 45%, p' },

    { id:'m12-20esp-5', num:'5', page:4, tipo:'dev', tema:'integrais',
      enun:'Calcule o integral definido e determine a área pedida.',
      resolucao:'Como a sucessão (un ) é uma progressão geométrica, temos que un = u1 × rn−1 , com r < 0, porque a
progressão não é monótona.
Sabe-se que:
1
1
⇔ u1 × r2 =
12
12
• u18 = 4u20 ⇔ u1 × r17 = 4 × u1 × r19
• u3 =

Resolvendo o sistema seguinte, determinamos o valor do primeiro termo e da razão da progressão:




...
2
2
Assim, temos que a expressão do termo geral na forma a × bn , é:
n−1
n 
−1
n
...
× ' },
    ...
    { id:'m12-20esp-6', num:'6', page:4, tipo:'dev', tema:'logaritmos',
      ...
      resolucao:'Como o inverso de 2 é

Assim, temos que a sucessão não é nem uma progressão aritmética nem uma progressão geométrica.
Por outro lado verifica-se que os termos alternam sucessivamente entre dois valores, pelo que não é
1
monótona e como ≤ vn ≤ 2, ∀n ∈ N, logo (vn ) é uma sucessão limitada.
2
Resposta: Opção D
...
7.' },
    ...
    { id:'m12-20esp-7', num:'7', page:2, tipo:'dev', tema:'sucessoes',
      ...
      resolucao:'7.1. Escrevendo z1 na f.t. temos −1 − i = ρeiθ , onde:
p
√
√
• ρ = | − 1 − i| = (−1)2 + (−1)2 = 1 + 1 = 2
−1
• tg θ =
= 1 ; como sen θ < 0 e cos θ < 0, θ é um ângulo do 3.º quadrante, logo
−1
5π
π
θ=π+ =
...
4
• (z1 )4 =
= 4ei(5π) = 4ei(5π−4π) = 4eπi = −4
2ei( 4 ) =
2 e
Assim, para que z1 seja solução da equação
...
2 × (−1)
2
Pelo que, pela igualdade de dois números complexos vem que:
−4b = −2 ∧ −
...
1' },
    ...
    { id:'m12-20esp-9', num:'9', page:6, tipo:'dev', tema:'trigonometria',
      ...
      resolucao:'Como o domı́nio da função é 0, , não existem assı́ntotas não verticais.
2
i πh
E como a função resulta de operações com funções contı́nuas em, as retas 0, , as retas definida por
2
π
x = 0 e x = são as únicas retas que podem ser assı́ntotas do gráfico de f
2
Assim temos que:
e2×0 − 1
0
...
(fazendo y = 2x, temos que se x → 0+ , então y → 0+ )
...
Pelo que a reta x = 0 não é uma assı́ntota vertical do gráfico de f
...
lim' },
    ...
    { id:'m12-20esp-10', num:'10', page:6, tipo:'dev', tema:'limites',
      enun:'Estude os limites e assíntotas da função apresentada.',
      resolucao:'10.1. Como a função é contı́nua em R, também é contı́nua em x = 1, pelo que
g(1) = lim− g(x) = lim+ g(x)
x→1

x→1

Como lim+ g(x) = g(1) = 12 − 10 + 8 ln 1 = 1 − 10 + 8 × 0 = −9 + 0 = −9, calculando lim− g(x),
temos:
...
Assim, como g(1) = −9, e g é contı́nua, temos que:
lim g(x) = g(1) ⇔ −9 = −
...

π 7π
Calculando a taxa média de variação da função h no intervalo
;
, temos:
6 6
 
...
'25_f1': {
  ...
  questoes: [
    { id:'m12-25f1-1', num:'1', page:2, tipo:'dev', tema:'geometria',
      ...
      resolucao:'Calculando o valor do limite da sucessão, temos que:

3n

n 3 
...
2.' },
    ...
    { id:'m12-25f1-2', num:'2', page:2, tipo:'dev', tema:'probabilidades',
      ...
      resolucao:'2.1. Para averiguar se a função g é contı́nua em x = 0, temos que verificar se g(0) = lim− g(x) = lim+ g(x)
x→0
x→0
√
• g(0) = 2 sen2 (0) − 3 × 0 + 2 = 2 × 0 − 0 + 2 = 2
√
• lim+ f (x) = 2 sen2 (0+ ) − 3 × 0+ + 2 = 2 × 0 − 0 + 2 = 2
x→0
...
Como g(0) = lim g(x) = lim g(x), então' },
    ...
    { id:'m12-25f1-3', num:'3', page:3, tipo:'mc', tema:'geometria',
      ...
      resolucao:'Como em todas as linhas do triângulo de Pascal (à exceção da primeira), o segundo e o penúltimo números
da linha são iguais, então designado por n, cada um destes números, temos que:
√
n × n = 625 ⇔ n2 = 625 ⇔ n = ± 625 ⇔ n = ±25
Assim temos que o segundo número da linha é 25, pelo que todos os elementos desta linha são todos da
forma 25 Ck , e os elementos da linha anterior são da forma 24 Ck .
Desta forma o quinto elemento da linha anterior, correspondente a k = 4, é:
24
...
3/9' },
    ...
    { id:'m12-25f1-4', num:'4', page:3, tipo:'dev', tema:'funcoes',
      enun:'Estude a função f quanto à continuidade, monotonia, extremos e assíntotas.',
      resolucao:'Considerando a experiência aleatória que consiste em selecionar, ao acaso, um aluno da academia, e os
acontecimentos:
B:≪O aluno estar inscrito em ballet clássico≫
C:≪O aluno estar inscrito em dança contemporânea≫

Temos que P (B) = 0,6, P C ∩ B = 0,25 e P (B|C) = 0,5 .
Assim, considerando P (C) = k e organizando os dados numa tabela,
obtemos:
• P (B ∩ C) = P (B|C) × P (C) = 0,5 × k
Podemos assim, obter o valor de k:
P (C) = P (B ∩ C) + P B ∩ C
...

• P C = 1 − P (C) = 1 − k = 1 − 0,5 = 0,5

• P B ∩ C = P (B) − P (B ∩ C) = 0,6 − 0,5 × k =
= 0,6 − 0,5 × 0,5 = 0,35
...
Logo, a probabilidade de um aluno da academia, escolhido ao acaso, estar inscrito em ballet clássico, sabendo que não está inscrito em dança contemporânea, ou seja:


P B∩C
0,35
...
P C' },
    ...
    { id:'m12-25f1-5', num:'5', page:3, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'Inserindo numa lista da calculadora gráfica os dados relativos ao diâmetro biparietal, e calculando as
respetivas medidas estatı́sticas, verificamos que a média e a mediana são, respetivamente x ≈ 8,44 cm
e x̃ = 8,48 cm, pelo que a mediana dos diâmetros biparietais apresentados excede a respetiva média,
arredondada às centésimas, em 0,04 cm.
Procedendo da mesma forma para os dados correspondentes do perı́metro cefálico, verificamos que a
amplitude da amostra dos perı́metros cefálicos apresentados é 7,27 cm.
Com os dados das duas listas, podemos calcular o valor do coeficiente de correlação linear, cujo arredondamento às centésimas, é r ≈ 0,94 .
Usando a regressão linear anterior, representando a reta de regressão e usando-a para obter uma estimativa
do perı́metro cefálico à nascença, associado a diâmetro biparietal na trigésima quarta semana de gravidez
de 8,50 cm,' },

    { id:'m12-25f1-6', num:'6', page:4, tipo:'dev', tema:'integrais',
      enun:'Calcule o integral definido e determine a área pedida.',
      resolucao:'Como existem 10 algarismos diferentes para figurar em 4 posições, sendo a ordem relevante e podendo
surgir repetições dos algarismos, o número de casos possı́veis é 10 A′4 = 104 .
Como se pretende que o código um zero e a soma dos quatro algarismos seja ı́mpar, devemos considerar duas alternativas: o código ser formado pelo zero e três algarismos ı́mpares, ou então, pelo zero, por
dois algarismos pares e um algarismo ı́mpar.
• Assim, o número de códigos formados pelo zero e por 3 dos 5 algarismos ı́mpares (1,3,5,7 e 9),
considerando a ordem relevante e quatro posições diferentes a serem ocupadas pelo zero, é, 5 A3 × 4.
• Para a outra alternativa, podemos selecionar 2 dos 4 algarismos pares (2,4,6,8), sem considerar a
ordem relevante e 1 dos 5 algarismos ı́mpares e o zero, e para cada conjunto de 4 algarismos calcular
as ordenações diferentes possı́veis, ou seja, 4 C2 × 5' },
    ...
    { id:'m12-25f1-7', num:'7', page:4, tipo:'mc', tema:'probabilidades',
      ...
      resolucao:'Pela observação da equação da√circunferência podemos verificar que as coordenadas do centro são (−1,1)
e que o respetivo raio é AC = 4 = 2.
−−→ −→
Como AB · AC = 6, temos que:
−−→ −→
−−→
−→
−−→
AB · AC = 6 ⇔ cos α × AB × AC = 6 ⇔ cos α × AB × 2 = 6 ⇔
Como o triângulo ABC é isósceles (porque CA = CB), designado por M
o ponto médio do lado [AB], obtemos um triângulo [ACM ], retângulo em
M , tal que:
AM
cos α =
⇔ AM = 2 cos α
...
π
3
Desta forma, como α ∈ 0, , temos que cos α > 0, ou seja cos α =
eα= .
2
2
6
Como o triângulo [ABC] é isósceles, as amplitudes dos ângulos BAC e ABC são iguais, pelo que a
amplitude do ângulo ACB é:
B ÂC + AB̂C + AĈB = π ⇔
...
' },
    ...
    { id:'m12-25f1-8', num:'8', page:5, tipo:'dev', tema:'sucessoes',
      ...
      resolucao:'Como Im (w) = Re (w), então w é um número complexo da forma ρei( 4 ) .
π
...
3π
5π
iw3 = ei( 2 ) × ρei( 4 ) = ei( 2 ) × ρ3 ei(3× 4 ) = 1 × ρ3 ei( 2 + 4 ) = ρ3 ei( 4 + 4 ) = ρ3 ei 4
5π
Ou seja, como Arg (iw3 ) =
, então o afixo de iw3 pertence ao 3.º quadrante, pelo que, de entre as
4
opções apresentadas, o único ponto que pode ser o afixo deste número é o ponto C.
Resposta: Opção C' },
    ...
    { id:'m12-25f1-9', num:'9', page:5, tipo:'mc', tema:'complexos',
      ...
      resolucao:'Temos que:
• Como i19 = i3+4×4 = i3 = −i , então z1 = 2i19 = 2 × (−i) = −2i .
• z2 =
...
Assim, os números complexos z cujos afixos são equidistantes dos afixos de z1 e de z2 , são os que verificam
a condição:
|z − z1 | = |z − z2 | ⇔ |z − (−2i)| = |z − (−1 + 2i)| ⇔ |z + 2i| = |z + 1 − 2i|
Desta forma, escrevendo w na forma algébrica, vem:
√
...
Substituindo, na condição de colinearidade, e resolvendo a equação, obtemos o valor de k:
|w + 2i| = |w + 1 − 2i| ⇔ |k − ki + 2i| = |k − ki + 1 − 2i| ⇔ |k + i(−k + 2)| = |k + 1 + i(−k − 2)| ⇔
p
p
⇔
k 2 + (−k + 2)2 = (k + 1)2 + (−k − 2)2 ⇔ k 2 + (−k + 2)2 = (k + 1)2 + (−k − 2)2 ⇔
⇔ k 2 + k 2 − 4k + 4 = k 2 + 2k + 1 + k 2 + 4k + 4 ⇔ −4' },

    { id:'m12-25f1-10', num:'10', page:2, tipo:'dev', tema:'logaritmos',
      enun:'Resolva a equação ou inequação logarítmica/exponencial.',
      resolucao:'10.1. Como se pretende identificar uma reta perpendicular à reta DF , e os respetivos vetores diretores
são perpendiculares, calculamos os produtos escalares entre os vetores diretores das retas de cada
uma das hipóteses o vetor diretor da reta DF para encontrar um produtos escalares nulos e assim
identificar direções perpendiculares à reta DF :
• (1,1, − 5) · (5,0, − 1) = 1 × 5 + 1 × 0 − 5 × (−1) = 5 + 0 + 5 = 10
• (1,1, − 5) · (0,5,1) = 1 × 0 + 1 × 5 − 5 × 1 = 0 + 5 − 5 = 0
Assim, temos que apenas as retas cujas equações são apresentadas nas opções (B) e (D) são perpendiculares à reta DF , pelo que resta verificar a qual das duas retas pertence o ponto A, substituindo
as suas' },

    { id:'m12-25f1-11', num:'11', page:5, tipo:'mc', tema:'limites',
      enun:'Questão sobre limites e continuidade.',
      opts:['(A) 0','(B) 1','(C) 2','(D) +∞'], correct:'C',
      resolucao:'Designando por k o instante em causa, o número de gafanhotos nesse instante é G(k) e metade deste
G(k)
número é
. Passadas quatro semanas, o número de gafanhotos é G(k + 4), pelo que uma equação
2
que permite determinar o instante é:
G(k)
= G(k + 4)
2
Desta forma, inserimos na calculadora gráfica a expressão da função f (x) = 0,9e−0,6x (x + 0,5)3 , e visualizamos os gráficos das funções:
f (x)
• g(x) =
2
• h(x) = f (x + 4)
...
reproduzidos na figura ao lado. Usando a função
da calculadora para determinar valores aproximados das coordenadas do ponto de interseção de dois
gráficos, obtemos o valor aproximado (arredondada
às centésimas) da abcissa do ponto de interseção das
funções g e h, a que correspondem o instante k:
...
Assim, desde as zero horas do dia em que o enxame foi localizado até esse instante até ao instante em
causa, deco' },

    { id:'m12-25f1-12', num:'12', page:2, tipo:'dev', tema:'trigonometria',
      enun:'Problema de trigonometria com as condições da figura.',
      resolucao:'12.1. Calculando a ordenada do ponto B, temos:
yB = f (0) = 3e0 − 2e−0 = 3 × 1 − 2 × 1 = 3 − 2 = 1
A abcissa do ponto A é obtida como a solução da equação seguinte:
f (x) = 5 ⇔ 3ex − 2e−x = 5 ⇔ 3ex − 2 ×
⇔
...
2
5ex
− x − x = 0 x⇔ 3(ex )2 − 2 − 5ex = 0 ⇔ 3(ex )2 − 5ex − 2 = 0
x
e ̸=0
e
e
...
Fazendo a substituição de variável y = ex , e usando a fórmula resolvente, vem:
2
...
Assim,temos que as coordenadas dos pontos são O(0,0) ; B(0,1) ; A(ln 2,5)
e C(ln 2,0) .
...
Resposta: Opção A' },
    ...
    { id:'m12-25f2-2', num:'2', page:2, tipo:'dev', tema:'funcoes',
      ...
      resolucao:'Relativamente a cada uma das quatro afirmações, temos que:
• Ordenando os valores relativos à produção de pera e à produção de maçã de 2019 a 2023, e identificando o valor central de cada uma das listas ordenadas, verificamos que as duas medianas são
x̃p = 12 197 kg/ha (pera) e x̃m = 21 330 kg/ha (maçã), pelo que a mediana dos valores de produção
de maçã excede a mediana dos valores de produção de pera em 21 330 − 12 197 = 9133 kg/ha.
• Em 2021 o aumento de produção de maçã foi de 26 644 − 20 087 = 6557 kg/ha relativamente a 2020,
a que corresponde a seguinte percentagem, p relativamente à produção de 2020:
p
6557
6557 × 100
=
...
20 087
20 087
• Inserindo numa lista da calculadora gráfica os dados relativos à produção de pera, entre 2019 e 2023
e calculando as respetivas medidas estatı́sticas, verificamos que os valores aproximados da média ' },
    ...
    { id:'m12-25f2-3', num:'3', page:2, tipo:'mc', tema:'combinatoria',
      ...
      resolucao:'3.1. Para averiguar se a função f é contı́nua em x = 0, temos que verificar se f (0) = lim f (x) = lim f (x)
x→0−
...
e0
1
Como f (0) = lim+ f (x) = lim− f (x), então a função f é contı́n' },

    { id:'m12-25f2-4', num:'4', page:3, tipo:'dev', tema:'derivadas',
      enun:'Estude a função f quanto à monotonia e extremos.',
      resolucao:'As soluções da equação pertencem ao conjunto x ∈ R : (4 − x)2 > 0 ∧ 4 − x > 0 ∧ 7 − 2x > 0
Como;
• (4 − x)2 > 0 é uma proposição verdadeira se 4 − x ̸= 0 então (4 − x)2 > 0 ⇒ x ̸= 4
• 4 − x > 0 ⇔ −x > −4 ⇔ x < 4
• 7 − 2x > 0 ⇔ −2x > −7 ⇔ 2x < 7 ⇔ x <
...
então (4 − x)2 > 0 ∧ 4 − x > 0 ∧ 7 − 2x > 0 ⇔ x <



7
7
, pelo que x ∈ −∞, , e resolvendo a equação,
2
2
...
1 x
1
e ln(4 − x)2 − 5 ln(4 − x) = (5 − ex ) ln(7 − 2x) ⇔ ex × 2 ln(4 − x) − 5 ln(4 − x) = (5 − ex ) ln(7 − 2x) ⇔
2
2

⇔ ex ln(4 − x) − 5 ln(4 − x) = (5 − ex ) ln(7 − 2x) ⇔ ln(4 − x) ex − 5 = −(ex − 5) ln(7 − 2x) ⇔


⇔ ln(4 − x) ex − 5 + (ex − 5) ln(7 − 2x) = 0 ⇔ (ex − 5) ln(4 − x) + ln(7 − 2x) = 0 ⇔


⇔ (ex − 5) ln (4 − x)(7 − 2x) = 0 ⇔ ex − 5 = 0 ∨ ln (4 − x)(7 − 2x) = 0 ⇔
⇔ ex = 5 ∨ (4 − x)(7 − 2x) = e0 ⇔ x = ln 5 ∨ 28 − 8x − 7x + 2x2 = 1 ⇔
p
−(−15) ± (−15)2 − 4(2)(27)
2
⇔
⇔ x = ln 5 ∨ 2x − 15x − 27' },
    ...
    { id:'m12-25f2-5', num:'5', page:4, tipo:'dev', tema:'probabilidades',
      enun:'Problema de probabilidade com as condições dadas.',
      resolucao:'De acordo com os dados do enunciado, temos que:

• P A ∩ B = 0,5 ⇔ P (A \\ B) = 0,5 ⇔ P (A) − P (A ∩ B) = 0,5


• P A ∩ B = 0,3 ⇔ P A ∪ B = 0,3 ⇔ 1 − P (A ∪ B) = 0,3 ⇔ P (A ∪ B) = 0,7
Logo, vem que:
P (A ∪ B) = P (A) + P (B) − P (A ∩ B) ⇔ 0,7 = 0,5 + P (B) ⇔ 0,2 = P (B)
Resposta: Opção A
...
4/9' },
    ...
    { id:'m12-25f2-6', num:'6', page:4, tipo:'dev', tema:'integrais',
      ...
      resolucao:'De acordo com os dados do enunciado, temos que:
• o número de rapazes da turma é: 25 × 0,64 = 16
3
• o número de rapazes com 17 anos é: 16 × = 12
4
• o número de rapazes com 18 anos é: 16 − 12 = 4
• o número de raparigas da turma é: 25 − 16 = 9
1
• o número de raparigas com 18 anos é: 9 × = 3
3
• o número de alunos com 18 anos é: 4 + 3 = 7
• o número de alunos com 17 anos é: 25 − 7 = 18
...
Logo existem 25 C6 grupos diferentes de seis alunos da turma, dos quais 1 × 1 × (18 − 2) × 7 C3 são
constituı́dos pela Isabel, pelo José, por um dos restantes 16 alunos com 17 anos e por três alunos com 18
anos.
Assim, recorrendo à regra de LaPlace, a probabilidade do grupo ter esta constituição, na forma de dı́zima,
arredondado às milésimas, é:
16 × 7 C3
≈ 0,003
25 C
6' },
    ...
    { id:'m12-25f2-7', num:'7', page:5, tipo:'mc', tema:'limites',
      ...
      opts:['(A) -2','(B) -1','(C) 1','(D) 2'], correct:'D',
      resolucao:'Como OZ = OW e M é o ponto médio do segmento de reta [W Z],
então temos que o Z ÔM = M ÔW .
Como M pertence à bissetriz dos quadrantes ı́mpares, e
˙ define com
Z ÔM = M ÔW , então o ângulo que a semirreta OZ
˙
semieixo positivo real e o ângulo que a semirreta OW define com
semieixo positivo imaginário também são iguais, pelo que:
...
2
2 2
Assim, simplificando a expressão do número complexo z, temos:
z=
...
5
+ 2e 4 = a ×
× i15 + 2ei 4 = a(1 + 2i) × (−i) + (1 − i) = a(−i − 2i2 ) + 1 − i =
1 − 2i
1 − 2i
= a(2 − i) + 1 − i = 2a − ai + 1 − i = 2a + 1 + i(−a − 1)

Como Im (z) − Re (z) = 1, vem que:
−a − 1 − (2a + 1) = 1 ⇔ −a − 1 − 2a − 1 = 1 ⇔ −3a = 1 + 2 ⇔ −3a = 3 ⇔ a = −

3
⇔ a = −1
3

Logo, temos que z = 2a + 1 + i(−a − 1) = 2(−1) + 1 + i(−(−1) − 1) = −2 + 1 + i(1 − 1) = −1 .
E assim, como o afixo de z pertence ao semieixo real negativo e |z| = 1, escrevendo z na forma trigonométrica, temos z = 1 × eiπ = eiπ .
...
Assim, como o ponto A está
a' },

    { id:'m12-25f2-9', num:'9', page:6, tipo:'mc', tema:'probabilidades',
      enun:'Questão de escolha múltipla sobre probabilidades.',
      opts:['(A) 1/5','(B) 2/5','(C) 3/5','(D) 4/5'], correct:'A',
      resolucao:'Considerando o lado [AC] como a base do triângulo, a altura
será o segmento que contém o ponto B e a projeção ortogonal do
ponto C, C ′ , sobre a reta de equação x = 1.
...
• BC ′ = sen α + | tg α| = sen α − tg α
B
Assim a área do triângulo [ABC], em função de α, é:
...
10.' },
    ...
    { id:'m12-25f2-10', num:'10', page:2, tipo:'dev', tema:'complexos',
      ...
      resolucao:'10.1. Como [ABCD] é um quadrado de lado AB e [AC] é uma diagonal, temos que:
−−→ −→ π
• ABˆAC =
4
√ 2 √ 2
...
−−→ −→
π √
AB · AC = cos ABˆAC × AB × AC = cos × 6 × 12 = 6
4
Resposta: Opção D
...
6/9' },
    ...
    { id:'m12-25f2-11', num:'11', page:2, tipo:'mc', tema:'geometria',
      ...
      resolucao:'11.1. Para estudar o sentido o sentido das concavidades e a existência de pontos de inflexão, começamos
por determinar a expressão da segunda derivada:
 ′

′
′
...
Como x ∈ 0, , g ′′ (x) = 0 ⇔ x =
∨ x=
. Desta forma, estudando a variação de sinal de
2
18
18
′′
g no interv' },
    ...
    { id:'m12-25f2-12', num:'12', page:2, tipo:'dev', tema:'derivadas',
      ...
      resolucao:'O valor total que se prevê obter com a venda é produto do preço de cada unidade, p, pelo número de
unidades vendidas, N (p). Assim o valor total, em função do preço é dado por p × N (p), e o preço que
permite obter um valor total igual a 4000 centenas de euros é a solução da equação:
p × N (p) = 4000
Desta forma, inserimos na calculadora gráfica as expressões das funções:

• f (x) = x 4000 × e−0,34x − 1,12x + 50
...
e visualizamos os respetivos gráficos numa janelaa compatı́vel com o domı́nio da função (2 ≤ x ≤ 10) gráficos
das funções, reproduzidos na figura ao lado.
Usando a função da calculadora para determinar valores aproximados das coordenad' }
  ]
}
