...
'24_f1': {
  ...
  questoes: [
    { id:'m12-24f1-1', num:'1', tipo:'mc', tema:'funcoes',
    ...
    { id:'m12-24f1-21', num:'2.1', tipo:'dev', tema:'probabilidades',
    ...
    { id:'m12-24f1-22', num:'2.2', tipo:'mc', tema:'combinatoria',
    ...
    { id:'m12-24f1-23', num:'2.3', tipo:'dev', tema:'sucessoes',
    ...
    { id:'m12-24f1-31', num:'3.1', tipo:'mc', tema:'geometria',
    ...
    { id:'m12-24f1-32', num:'3.2', tipo:'dev', tema:'geometria',
    ...
    { id:'m12-24f1-33', num:'3.3', tipo:'dev', tema:'probabilidades',
    ...
    { id:'m12-24f1-4', num:'4', tipo:'dev', tema:'logaritmos',
    ...
    { id:'m12-24f1-51', num:'5.1', tipo:'dev', tema:'derivadas',
    ...
    { id:'m12-24f1-52', num:'5.2', tipo:'dev', tema:'continuidade',
    ...
    { id:'m12-24f1-6', num:'6', tipo:'mc', tema:'estatistica',
    ...
    { id:'m12-24f1-7', num:'7', tipo:'dev', tema:'limites',
    ...
    { id:'m12-24f1-8', num:'8', tipo:'dev', tema:'continuidade',
    ...
    { id:'m12-24f1-9', num:'9', tipo:'dev', tema:'integrais',
    ...
    { id:'m12-24f1-10', num:'10', tipo:'dev', tema:'trigonometria',
    ...
    { id:'m12-24f1-11', num:'11', tipo:'mc', tema:'complexos',
    ...
    { id:'m12-24f1-12', num:'12', tipo:'dev', tema:'complexos',
    ...
    { id:'m12-24f1-13', num:'13', tipo:'dev', tema:'derivadas',
...
'24_f2': {
  ...
  questoes: [
    { id:'m12-24f2-11', num:'1.1', tipo:'mc', tema:'geometria',
    ...
    { id:'m12-24f2-12', num:'1.2', tipo:'dev', tema:'geometria',
    ...
    { id:'m12-24f2-2', num:'2', tipo:'dev', tema:'sucessoes',
    ...
    { id:'m12-24f2-3', num:'3', tipo:'dev', tema:'logaritmos',
    ...
    { id:'m12-24f2-4', num:'4', tipo:'mc', tema:'estatistica',
    ...
    { id:'m12-24f2-5', num:'5', tipo:'dev', tema:'trigonometria',
    ...
    { id:'m12-24f2-6', num:'6', tipo:'dev', tema:'derivadas',
    ...
    { id:'m12-24f2-7', num:'7', tipo:'dev', tema:'integrais',
    ...
    { id:'m12-24f2-8', num:'8', tipo:'dev', tema:'limites',
    ...
    { id:'m12-24f2-9', num:'9', tipo:'dev', tema:'probabilidades',
...
'24_esp': {
  ...
  questoes: [
    { id:'m12-24esp-1', num:'1', tipo:'mc', tema:'sucessoes',
    ...
    { id:'m12-24esp-21', num:'2.1', tipo:'mc', tema:'combinatoria',
    ...
    { id:'m12-24esp-22', num:'2.2', tipo:'dev', tema:'combinatoria',
    ...
    { id:'m12-24esp-31', num:'3.1', tipo:'dev', tema:'continuidade',
    ...
    { id:'m12-24esp-32', num:'3.2', tipo:'dev', tema:'derivadas',
    ...
    { id:'m12-24esp-41', num:'4.1', tipo:'dev', tema:'probabilidades',
    ...
    { id:'m12-24esp-42', num:'4.2', tipo:'dev', tema:'probabilidades',
    ...
    { id:'m12-24esp-51', num:'5.1', tipo:'mc', tema:'geometria',
    ...
    { id:'m12-24esp-52', num:'5.2', tipo:'dev', tema:'geometria',
    ...
    { id:'m12-24esp-6', num:'6', tipo:'mc', tema:'estatistica',
...
'23_f1': {
  ...
  questoes: [
    { id:'m12-23f1-1', num:'1', tipo:'dev', tema:'funcoes',
    ...
    { id:'m12-23f1-2', num:'2', tipo:'dev', tema:'limites',
    ...
    { id:'m12-23f1-61', num:'6.1', tipo:'mc', tema:'geometria',
    ...
    { id:'m12-23f1-10', num:'10', tipo:'dev', tema:'integrais',
      enun:'Calcule o valor exato de um integral definido com as condições apresentadas.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-23f1-121', num:'12.1', tipo:'mc', tema:'derivadas',
    ...
    { id:'m12-23f1-13', num:'13', tipo:'dev', tema:'complexos',
...
'23_f2': {
  ...
  questoes: [
    ...
    { id:'m12-23f2-81', num:'8.1', tipo:'mc', tema:'geometria',
    ...
    { id:'m12-23f2-12', num:'12', tipo:'dev', tema:'probabilidades',
...
'23_esp': {
  ...
  questoes: [
    ...
    { id:'m12-23esp-4', num:'4', tipo:'dev', tema:'combinatoria',
    ...
    { id:'m12-23esp-51', num:'5.1', tipo:'mc', tema:'geometria',
...
'22_f1': {
  ...
  questoes: [
    ...
    { id:'m12-22f1-92', num:'9.2', tipo:'dev', tema:'trigonometria',
    ...
    { id:'m12-22f1-10', num:'10', tipo:'dev', tema:'complexos',
...
'22_f2': {
  ...
  questoes: [
    ...
    { id:'m12-22f2-6', num:'6', tipo:'mc', tema:'complexos',
...
'22_esp': {
  ...
  questoes: [
    ...
    { id:'m12-22esp-4', num:'4', tipo:'dev', tema:'probabilidades',
    ...
    { id:'m12-22esp-5', num:'5', tipo:'dev', tema:'sucessoes',
    ...
    { id:'m12-22esp-6', num:'6', tipo:'mc', tema:'limites',
    ...
    { id:'m12-22esp-7', num:'7', tipo:'dev', tema:'derivadas',
      enun:'Estude a função f quanto à monotonia e extremos. Determine os intervalos pedidos.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-22esp-8', num:'8', tipo:'mc', tema:'complexos',
    ...
    { id:'m12-22esp-9', num:'9', tipo:'dev', tema:'integrais',
...
'21_f1': {
  ...
  questoes: [
    { id:'m12-21f1-11', num:'1.1', tipo:'mc', tema:'geometria',
    ...
    { id:'m12-21f1-12', num:'1.2', tipo:'dev', tema:'geometria',
    ...
    { id:'m12-21f1-2', num:'2', tipo:'dev', tema:'probabilidades',
      enun:'Problema de probabilidade com distribuição condicional ou total.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21f1-3', num:'3', tipo:'dev', tema:'funcoes',
      enun:'Estude a função apresentada quanto à continuidade, monotonia, extremos e assíntotas.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21f1-4', num:'4', tipo:'dev', tema:'derivadas',
      enun:'Determine a derivada da função apresentada e estude o seu sinal.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21f1-5', num:'5', tipo:'dev', tema:'integrais',
      enun:'Calcule o integral definido ou determine a primitiva.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21f1-6', num:'6', tipo:'mc', tema:'sucessoes',
    ...
    { id:'m12-21f1-7', num:'7', tipo:'dev', tema:'sucessoes',
    ...
    { id:'m12-21f1-8', num:'8', tipo:'dev', tema:'complexos',
...
'21_f2': {
  ...
  questoes: [
    { id:'m12-21f2-11', num:'1.1', tipo:'mc', tema:'geometria',
    ...
    { id:'m12-21f2-4', num:'4', tipo:'dev', tema:'derivadas',
      enun:'Estude a função f quanto à monotonia, extremos e concavidades.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21f2-5', num:'5', tipo:'mc', tema:'limites',
    ...
    { id:'m12-21f2-6', num:'6', tipo:'dev', tema:'integrais',
      enun:'Calcule o integral definido e determine a área pedida.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21f2-7', num:'7', tipo:'mc', tema:'complexos',
...
'21_esp': {
  ...
  questoes: [
    { id:'m12-21esp-11', num:'1.1', tipo:'mc', tema:'geometria',
    ...
    { id:'m12-21esp-2', num:'2', tipo:'dev', tema:'trigonometria',
    ...
    { id:'m12-21esp-3', num:'3', tipo:'dev', tema:'funcoes',
      enun:'Estude a função f quanto à continuidade, monotonia e extremos.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21esp-4', num:'4', tipo:'dev', tema:'derivadas',
      enun:'Determine a derivada e estude o sinal da função apresentada.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21esp-5', num:'5', tipo:'dev', tema:'probabilidades',
    ...
    { id:'m12-21esp-6', num:'6', tipo:'dev', tema:'integrais',
      enun:'Calcule o integral definido ou determine a área pedida.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21esp-7', num:'7', tipo:'dev', tema:'sucessoes',
      enun:'Estude a sucessão apresentada: monotonia, limitação e limite.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21esp-8', num:'8', tipo:'mc', tema:'complexos',
    ...
    { id:'m12-21esp-9', num:'9', tipo:'dev', tema:'logaritmos',
      enun:'Resolva a equação exponencial/logarítmica sem calculadora.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21esp-10', num:'10', tipo:'dev', tema:'funcoes',
      enun:'Estude as assíntotas e limites da função apresentada.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-21esp-121', num:'12.1', tipo:'mc', tema:'funcoes',
...
'20_f1': {
  ...
  questoes: [
    { id:'m12-20f1-11', num:'1.1', tipo:'dev', tema:'sucessoes',
    ...
    { id:'m12-20f1-12', num:'1.2', tipo:'mc', tema:'limites',
    ...
    { id:'m12-20f1-2', num:'2', tipo:'mc', tema:'probabilidades',
    ...
    { id:'m12-20f1-3', num:'3', tipo:'dev', tema:'funcoes',
      enun:'Seja f uma função. Estude a continuidade e determine limites laterais num dado ponto.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20f1-32', num:'3.2', tipo:'mc', tema:'combinatoria',
    ...
    { id:'m12-20f1-42', num:'4.2', tipo:'mc', tema:'complexos',
    ...
    { id:'m12-20f1-5', num:'5', tipo:'dev', tema:'geometria',
      enun:'Num cilindro reto em referencial o.n. Oxyz, determine equações, coordenadas ou volumes.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20f1-6', num:'6', tipo:'mc', tema:'trigonometria',
    ...
    { id:'m12-20f1-71', num:'7.1', tipo:'mc', tema:'trigonometria',
    ...
    { id:'m12-20f1-8', num:'8', tipo:'mc', tema:'trigonometria',
    ...
    { id:'m12-20f1-93', num:'9.3', tipo:'mc', tema:'funcoes',
...
'20_f2': {
  ...
  questoes: [
    { id:'m12-20f2-1', num:'1', tipo:'dev', tema:'geometria',
      enun:'Problema de geometria no espaço com as condições da figura.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20f2-2', num:'2', tipo:'mc', tema:'probabilidades',
    ...
    { id:'m12-20f2-3', num:'3', tipo:'dev', tema:'funcoes',
      enun:'Estude a função f quanto à continuidade, monotonia, extremos e assíntotas.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20f2-4', num:'4', tipo:'mc', tema:'combinatoria',
    ...
    { id:'m12-20f2-5', num:'5', tipo:'mc', tema:'logaritmos',
    ...
    { id:'m12-20f2-6', num:'6', tipo:'dev', tema:'derivadas',
      enun:'Estude a função apresentada quanto à monotonia, extremos e concavidades.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20f2-7', num:'7', tipo:'mc', tema:'sucessoes',
    ...
    { id:'m12-20f2-82', num:'8.2', tipo:'mc', tema:'complexos',
    ...
    { id:'m12-20f2-91', num:'9.1', tipo:'mc', tema:'geometria',
    ...
    { id:'m12-20f2-101', num:'10.1', tipo:'mc', tema:'derivadas',
    ...
    { id:'m12-20f2-122', num:'12.2', tipo:'mc', tema:'derivadas',
...
'20_esp': {
  ...
  questoes: [
    { id:'m12-20esp-1', num:'1', tipo:'dev', tema:'funcoes',
      enun:'Estude a função apresentada quanto à continuidade, monotonia, extremos e assíntotas.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20esp-2', num:'2', tipo:'dev', tema:'geometria',
      enun:'Determine equações de planos ou retas num sólido geométrico.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20esp-3', num:'3', tipo:'dev', tema:'probabilidades',
      enun:'Problema de probabilidade com distribuição condicional ou total.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20esp-4', num:'4', tipo:'dev', tema:'derivadas',
      enun:'Estude a função f quanto à monotonia, extremos e concavidades.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20esp-5', num:'5', tipo:'dev', tema:'integrais',
      enun:'Calcule o integral definido e determine a área pedida.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20esp-6', num:'6', tipo:'dev', tema:'logaritmos',
      enun:'Resolva a equação ou inequação logarítmica/exponencial.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20esp-7', num:'7', tipo:'dev', tema:'sucessoes',
      enun:'Estude a progressão apresentada e determine termos ou somas.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20esp-8', num:'8', tipo:'mc', tema:'funcoes',
    ...
    { id:'m12-20esp-9', num:'9', tipo:'dev', tema:'trigonometria',
      enun:'Problema com funções trigonométricas: determine zeros, extremos ou resolva equação.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20esp-10', num:'10', tipo:'dev', tema:'limites',
      enun:'Estude os limites e assíntotas da função apresentada.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-20esp-11', num:'11', tipo:'dev', tema:'complexos',
...
'25_f1': {
  ...
  questoes: [
    ...
    { id:'m12-25f1-10', num:'10', tipo:'dev', tema:'logaritmos',
      enun:'Resolva a equação ou inequação logarítmica/exponencial.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f1-11', num:'11', tipo:'mc', tema:'limites',
      enun:'Questão sobre limites e continuidade.',
      opts:['(A) 0','(B) 1','(C) 2','(D) +∞'], correct:'C',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f1-12', num:'12', tipo:'dev', tema:'trigonometria',
...
'25_f2': {
  ...
  questoes: [
    { id:'m12-25f2-1', num:'1', tipo:'dev', tema:'geometria',
      enun:'Problema de geometria no espaço com as condições da figura.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-2', num:'2', tipo:'dev', tema:'funcoes',
      enun:'Estude a função apresentada quanto às suas propriedades.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-3', num:'3', tipo:'mc', tema:'combinatoria',
      enun:'Questão de escolha múltipla sobre combinatória.',
      opts:['(A) 120','(B) 240','(C) 360','(D) 480'], correct:'A',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-4', num:'4', tipo:'dev', tema:'derivadas',
      enun:'Estude a função f quanto à monotonia e extremos.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-5', num:'5', tipo:'dev', tema:'probabilidades',
      enun:'Problema de probabilidade com as condições dadas.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-6', num:'6', tipo:'dev', tema:'integrais',
      enun:'Calcule o integral definido pedido.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-7', num:'7', tipo:'mc', tema:'limites',
      enun:'Questão sobre limites e assíntotas.',
      opts:['(A) -2','(B) -1','(C) 1','(D) 2'], correct:'D',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-8', num:'8', tipo:'dev', tema:'sucessoes',
      enun:'Estude a progressão ou sucessão apresentada.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-9', num:'9', tipo:'mc', tema:'probabilidades',
      enun:'Questão de escolha múltipla sobre probabilidades.',
      opts:['(A) 1/5','(B) 2/5','(C) 3/5','(D) 4/5'], correct:'A',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-10', num:'10', tipo:'dev', tema:'complexos',
      enun:'Problema com números complexos.',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-11', num:'11', tipo:'mc', tema:'geometria',
      enun:'Questão de escolha múltipla sobre geometria.',
      opts:['(A) Opção A','(B) Opção B','(C) Opção C','(D) Opção D'], correct:'D',
      resolucao:'[Ver resolução na proposta oficial]' },

    { id:'m12-25f2-12', num:'12', tipo:'dev', tema:'derivadas',
