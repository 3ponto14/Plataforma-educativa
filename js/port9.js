...
var _port9Subtemas = {
  1: ['Teatro de Gil Vicente', 'Os Lusíadas', 'Contos', 'Poesia'],
...
var _port9Banco = {
  // ── Domínio 1 · Educação Literária ──
  1: [
    // ── INTERPRETAÇÃO DE VERSOS — Os Lusíadas ──
    { t: '2', tipo: 'mc', dif: 'medio', enun: 'Lê: «As armas e os <b>barões assinalados</b> / Que da Ocidental praia Lusitana…». O que anuncia o sujeito poético com estes versos?', opcoes: ['que vai cantar os feitos heroicos dos portugueses', 'que vai falar de uma guerra entre deuses', 'que vai contar uma história de amor', 'que vai descrever a cidade de Lisboa'], resposta: 'que vai cantar os feitos heroicos dos portugueses', expl: '«Barões assinalados» = homens notáveis. É a Proposição: Camões anuncia o tema, os feitos do povo português.', tema: 'T2 · Os Lusíadas' },
    { t: '2', tipo: 'mc', dif: 'medio', enun: 'Lê: «<b>Vós, Tágides minhas</b>, pois criado / Tendes em mim um novo engenho ardente…». Porque é que Camões invoca as Tágides (ninfas do Tejo) e não as Musas gregas?', opcoes: ['para dar uma marca portuguesa à sua inspiração', 'porque não conhecia as Musas gregas', 'para criticar a mitologia clássica', 'por serem mais fáceis de rimar'], resposta: 'para dar uma marca portuguesa à sua inspiração', expl: 'Ao invocar ninfas do Tejo (rio português) em vez das Musas, Camões nacionaliza a inspiração — patriotismo.', tema: 'T2 · Os Lusíadas' },
    { t: '2', tipo: 'mc', dif: 'dificil', enun: 'No episódio de Inês de Castro: «<b>Estavas, linda Inês, posta em sossego</b>, / De teus anos colhendo doce fruito…». Que efeito cria este início sereno?', opcoes: ['contrasta com a tragédia que se segue, tornando-a mais comovente', 'mostra que Inês era uma personagem feliz para sempre', 'indica que nada de mau vai acontecer', 'descreve uma paisagem sem importância'], resposta: 'contrasta com a tragédia que se segue, tornando-a mais comovente', expl: 'A calma inicial («sossego», «doce fruito») contrasta com o assassínio que vem a seguir — o contraste aumenta a emoção.', tema: 'T2 · Os Lusíadas' },
    { t: '2', tipo: 'mc', dif: 'dificil', enun: 'O Adamastor diz: «<b>Eu sou aquele oculto e grande Cabo / A quem chamais vós outros Tormentório</b>». O que representa esta figura?', opcoes: ['os perigos e o medo do mar desconhecido', 'a saudade da terra natal', 'a alegria da chegada à Índia', 'a amizade entre os marinheiros'], resposta: 'os perigos e o medo do mar desconhecido', expl: 'O Adamastor é a personificação do Cabo das Tormentas — encarna os perigos e o terror do mar nunca antes navegado.', tema: 'T2 · Os Lusíadas' },
    { t: '2', tipo: 'mc', dif: 'medio', enun: 'Em «<b>Inês, que depois de morta foi rainha</b>», que recurso e que sentido se destacam?', opcoes: ['um paradoxo trágico: só depois de morta foi reconhecida', 'uma comparação entre Inês e uma rainha viva', 'uma simples informação histórica', 'uma metáfora sobre a beleza'], resposta: 'um paradoxo trágico: só depois de morta foi reconhecida', expl: 'Ser «rainha depois de morta» é um paradoxo que reforça a injustiça e a tragédia — D. Pedro coroou-a já morta.', tema: 'T2 · Os Lusíadas' },
    // ── Auto da Barca do Inferno (Gil Vicente) ──
    { t: '1', tipo: 'mc', dif: 'medio', enun: 'No Auto da Barca do Inferno, o Fidalgo leva consigo uma cadeira e um pajem. O que critica Gil Vicente através disto?', opcoes: ['a vaidade e o apego aos bens e ao estatuto social', 'a pobreza dos nobres', 'a falta de educação do Fidalgo', 'o gosto por viajar'], resposta: 'a vaidade e o apego aos bens e ao estatuto social', expl: 'O Fidalgo quer levar para a morte os símbolos do seu estatuto — Gil Vicente satiriza a vaidade da nobreza.', tema: 'T1 · Auto da Barca' },
    { t: '1', tipo: 'mc', dif: 'dificil', enun: 'Apenas o Parvo e os Quatro Cavaleiros se salvam no Auto da Barca. Que crítica social faz Gil Vicente com esta escolha?', opcoes: ['os humildes e quem morre por uma causa valem mais que os poderosos', 'só os tolos vão para o céu', 'os cavaleiros eram os mais ricos', 'a salvação depende da sorte'], resposta: 'os humildes e quem morre por uma causa valem mais que os poderosos', expl: 'Salvar o Parvo (humilde e inocente) e os Cavaleiros (mortos na fé) — e condenar os poderosos — é uma crítica à hipocrisia social.', tema: 'T1 · Auto da Barca' },
    { t: '1', tipo: 'mc', dif: 'medio', enun: 'O Onzeneiro, no Auto da Barca, é castigado por quê?', opcoes: ['pela usura — emprestar dinheiro a juros altos por ganância', 'por ser muito pobre', 'por roubar a barca', 'por não acreditar em Deus'], resposta: 'pela usura — emprestar dinheiro a juros altos por ganância', expl: 'O Onzeneiro («onze por dez») representa a cobiça pelo dinheiro; é condenado pela avareza.', tema: 'T1 · Auto da Barca' },
    // ── Auto da Índia (Gil Vicente) — para escolas que dão esta obra ──
    { t: '1', tipo: 'mc', dif: 'medio', enun: 'No Auto da Índia, a Ama finge-se triste com a partida do marido para a Índia, mas afinal está contente. Que recurso usa Gil Vicente?', opcoes: ['ironia — diz o contrário do que sente, criticando a falsidade', 'comparação entre a Ama e o marido', 'hipérbole sobre a viagem', 'eufemismo sobre a morte'], resposta: 'ironia — diz o contrário do que sente, criticando a falsidade', expl: 'A Ama chora por fora e festeja por dentro — a ironia expõe a hipocrisia e a infidelidade, alvos da sátira.', tema: 'T1 · Auto da Índia' },
    { t: '1', tipo: 'mc', dif: 'dificil', enun: 'O que critica Gil Vicente, sobretudo, no Auto da Índia?', opcoes: ['a infidelidade e a falsidade dos costumes durante as viagens', 'a coragem dos marinheiros', 'a riqueza trazida da Índia', 'a falta de barcos'], resposta: 'a infidelidade e a falsidade dos costumes durante as viagens', expl: 'Com a Ama a trair o marido ausente, Gil Vicente satiriza os costumes e a moral da época dos Descobrimentos.', tema: 'T1 · Auto da Índia' },
    { t: '1', tipo: 'mc', dif: 'medio', enun: 'O Auto da Índia é uma comédia. Qual é a intenção de Gil Vicente ao fazer rir o público?', opcoes: ['criticar defeitos da sociedade de forma divertida (sátira)', 'apenas entreter, sem mensagem', 'ensinar a navegar', 'elogiar a corte'], resposta: 'criticar defeitos da sociedade de forma divertida (sátira)', expl: 'O riso é uma arma: a sátira de Gil Vicente faz rir para criticar os vícios e a hipocrisia da sociedade.', tema: 'T1 · Auto da Índia' },
    // ── Texto poético: interpretar a «voz» ──
    { t: '4', tipo: 'mc', dif: 'medio', enun: 'Num poema, quem exprime os sentimentos não é o autor mas uma voz criada por ele. Como se chama essa voz?', opcoes: ['sujeito poético', 'narrador', 'personagem', 'destinatário'], resposta: 'sujeito poético', expl: 'O sujeito poético (ou «eu lírico») é a voz que sente e fala no poema — não se confunde com o autor real.', tema: 'T4 · Poesia' }
  ],
  // ── Domínio 2 · Gramática ──
  2: [
