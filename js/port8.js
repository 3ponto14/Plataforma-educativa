...
var _port8Subtemas = {
  1: ['Narrativa (Sophia, Saramago…)', 'Texto dramático', 'Poesia', 'Texto não literário'],
...
var _port8Banco = {
  ...
  1: [
    ...
    { t: '2', tipo: 'mc', dif: 'dificil', enun: 'Quando uma personagem fala sozinha em voz alta, expondo os seus pensamentos, trata-se de um:', opcoes: ['monólogo', 'aparte', 'diálogo', 'narrador'], resposta: 'monólogo', expl: 'Monólogo = fala a solo; o aparte é uma fala ao público que as outras personagens «não ouvem».', tema: 'T2 · Texto dramático' },
    { t: '3', tipo: 'mc', dif: 'medio', enun: 'A «voz» que exprime emoções e ideias num poema chama-se:', opcoes: ['sujeito poético', 'poeta', 'narrador', 'declamador'], resposta: 'sujeito poético', expl: 'O sujeito poético é a entidade criada no texto — não se confunde com o poeta, a pessoa real.', tema: 'T3 · Poesia' },
    { t: '3', tipo: 'mc', dif: 'facil', enun: 'Uma quadra é uma estrofe de:', opcoes: ['quatro versos', 'dois versos', 'seis versos', 'oito versos'], resposta: 'quatro versos', expl: '2 = dístico; 3 = terceto; 4 = quadra; 6 = sextilha; 8 = oitava.', tema: 'T3 · Poesia' }
  ],
  // ── Domínio 2 · Gramática ──
  2: [
