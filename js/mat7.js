...
var _mat7Subtemas = {
  ...
  4: ['Expressões algébricas', 'Simplificação', 'Equações do 1.º grau', 'Inequações'],
...
var _mat7Cards = {
  ...
  { st: 3, tag:'Definição',q:'Quando é que dois triângulos são semelhantes?',a:'Quando têm a mesma forma (podem ter tamanhos diferentes): os ângulos correspondentes são iguais e os lados correspondentes são proporcionais.'},
  { st: 3, tag:'Critério',q:'Quais são os critérios de semelhança de triângulos?',a:'• AA: dois ângulos iguais\n• LLL: os três lados proporcionais\n• LAL: dois lados proporcionais e o ângulo entre eles igual'},
  { st: 3, tag:'Definição',q:'O que é a razão de semelhança entre dois triângulos?',a:'É o quociente entre lados correspondentes (k = lado da figura / lado do original). Se k = 2, o novo triângulo tem o dobro do tamanho.'},
  { st: 3, tag:'Exemplo',q:'Dois triângulos semelhantes têm razão k = 3. Se um lado do menor mede 4 cm, quanto mede o correspondente do maior?',a:'4 × 3 = 12 cm. Os lados correspondentes multiplicam-se pela razão de semelhança.'},
],
  4: [
    { st: 1, tag:'Definição',q:'O que é uma expressão algébrica?',a:'Combinação de números, variáveis (letras) e operações. Ex: 2x+7, 3(n−1), x²+5'},
    { st: 1, tag:'Definição',q:'O que é um monómio?',a:'Produto de um número (coeficiente) pelo produto de variáveis (parte literal).\nEx: em −5x, coeficiente = −5, parte literal = x'},
    { st: 1, tag:'Definição',q:'O que são termos semelhantes?',a:'Termos com a mesma parte literal (mesmas variáveis com os mesmos expoentes). Só estes se podem somar/subtrair.'},
    { st: 2, tag:'Regra',q:'Como simplificar termos semelhantes?',a:'Soma os coeficientes, mantém a parte literal.\nEx: 3x + 5x = 8x\nEx: 7y − 2y + y = 6y'},
    { st: 3, tag:'Definição',q:'O que é uma equação?',a:'Igualdade com uma ou mais incógnitas. Tem 1.º membro (antes do =) e 2.º membro (depois do =).'},
    { st: 3, tag:'Definição',q:'O que é a solução de uma equação?',a:'Valor da incógnita que torna a igualdade verdadeira. Para verificar: substitui e confirma se os dois membros são iguais.'},
    { st: 3, tag:'Definição',q:'O que são equações equivalentes?',a:'Equações que têm exatamente o mesmo conjunto-solução.\nEx: x+3=5 e 2x=4 são equivalentes (ambas têm x=2).'},
    { st: 3, tag:'Princípio',q:'Enuncia o Princípio Aditivo das equações.',a:'Se adicionarmos (ou subtrairmos) o mesmo número a ambos os membros, obtemos uma equação equivalente.'},
    { st: 3, tag:'Princípio',q:'Enuncia o Princípio Multiplicativo das equações.',a:'Se multiplicarmos (ou dividirmos) ambos os membros pelo mesmo número ≠ 0, obtemos uma equação equivalente.'},
    { st: 3, tag:'Regra',q:'O que é a transposição de termos?',a:'Mudar um termo de membro trocando o sinal.\nÉ consequência do princípio aditivo.\nEx: 3x + 5 = 11 ⟺ 3x = 11 − 5'},
    { st: 3, tag:'Classificação',q:'O que é uma equação Possível Determinada (PD)?',a:'Tem exatamente uma solução.\nForma reduzida: c·x = k com c ≠ 0\nS = {k/c}'},
    { st: 3, tag:'Classificação',q:'O que é uma equação Impossível (I)?',a:'Não tem solução.\nForma reduzida: 0·x = k com k ≠ 0\nS = ∅ (conjunto vazio)'},
    { st: 3, tag:'Classificação',q:'O que é uma equação Possível Indeterminada (PI)?',a:'Tem infinitas soluções.\nForma reduzida: 0·x = 0\nS = ℝ (todos os reais)'},
    { st: 3, tag:'Estratégia',q:'Como resolver um problema com equações?',a:'1) Define a variável\n2) Escreve a equação\n3) Resolve\n4) Verifica se faz sentido no contexto'},
    { st: 3, tag:'Nota',q:'O que são números consecutivos?',a:'Inteiros com diferença 1: n, n+1, n+2, …\nPares consecutivos: n, n+2, n+4, …\nÍmpares consecutivos: n, n+2, n+4, … (n ímpar)'},
    { st: 4, tag:'Desafio',q:'Quando é que ax+b=c é impossível?',a:'Quando a=0 e b≠c. Fica 0x = c−b (com c−b≠0).'},
    { st: 3, tag:'Estratégia',q:'Como resolver problemas com idades?',a:'1) Variável para idade atual\n2) "Daqui a k anos" → soma k\n3) Escreve equação\n4) Resolve e verifica'}
  ],
  5: [
