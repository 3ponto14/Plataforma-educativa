...
var PT_FUNCOES_BANCO = [
  ...
  { frase: 'O livro pertence <u>à biblioteca</u>.', alvo: 'à biblioteca', correct: 'complemento indireto', opts: ['complemento indireto','complemento oblíquo','modificador do grupo verbal','sujeito'], exp: '«À biblioteca» é complemento indireto - é substituível por «lhe»: «O livro pertence-lhe». (Classificação do Dicionário Terminológico, seguida nos manuais.)' },
