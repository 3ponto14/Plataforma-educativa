...
var _mat8Cards = {
  1: [
    { st: 1, tag: 'Definição', q: 'O que é uma dízima finita?', a: 'Uma dízima com um número finito de casas decimais. Acontece quando o denominador (reduzido) só tem fatores 2 e/ou 5. Ex: 3/5 = 0,6.' },
    { st: 1, tag: 'Definição', q: 'O que é uma dízima infinita periódica?', a: 'Uma dízima cujas casas decimais se repetem infinitamente, num período. Ex: 1/3 = 0,(3); 1/6 = 0,1(6).' },
    { st: 2, tag: 'Regra', q: 'Como multiplicar duas frações?', a: 'Multiplicam-se os numeradores entre si e os denominadores entre si: a/b × c/d = (a×c)/(b×d). Simplifica no fim.' },
    { st: 2, tag: 'Regra', q: 'Como dividir duas frações?', a: 'Multiplica-se a primeira pelo inverso da segunda: a/b ÷ c/d = a/b × d/c.' },
    { st: 1, tag: 'Definição', q: 'O que é o simétrico de um número?', a: 'É o número com sinal trocado. O simétrico de 3/5 é −3/5. A soma de um número com o seu simétrico é 0.' },
    { st: 1, tag: 'Definição', q: 'O que é o valor absoluto?', a: '|x| é a distância de x ao zero, é sempre ≥ 0. |−3/4| = 3/4 e |3/4| = 3/4.' },
    { st: 3, tag: 'Propriedade', q: 'Propriedade comutativa', a: 'A ordem dos fatores não altera o produto: a × b = b × a. Vale também para a adição.' },
    { st: 3, tag: 'Propriedade', q: 'Propriedade associativa', a: 'A forma de agrupar não altera o resultado: (a × b) × c = a × (b × c).' },
    { st: 3, tag: 'Propriedade', q: 'Propriedade distributiva', a: 'a × (b + c) = a × b + a × c. Permite "distribuir" a multiplicação pela soma/subtração.' },
    { st: 4, tag: 'Regra', q: 'Sinal de uma potência de base negativa', a: 'Expoente par → resultado positivo. Expoente ímpar → resultado negativo. (−2)⁴ = 16; (−2)³ = −8.' },
    { st: 4, tag: 'Propriedade', q: 'Produto de potências com a mesma base', a: 'aᵐ × aⁿ = aᵐ⁺ⁿ (mantém-se a base, somam-se os expoentes). Ex: 2³ × 2⁵ = 2⁸.' },
    { st: 4, tag: 'Propriedade', q: 'Quociente de potências com a mesma base', a: 'aᵐ ÷ aⁿ = aᵐ⁻ⁿ (mantém-se a base, subtraem-se os expoentes). Ex: 10⁷ ÷ 10³ = 10⁴.' },
    { st: 4, tag: 'Propriedade', q: 'Potência de uma potência', a: '(aᵐ)ⁿ = aᵐˣⁿ (mantém-se a base, multiplicam-se os expoentes). Ex: (2³)² = 2⁶.' },
    { st: 4, tag: 'Propriedade', q: 'Potências com o mesmo expoente', a: 'Produto: aⁿ × bⁿ = (a×b)ⁿ. Quociente: aⁿ ÷ bⁿ = (a÷b)ⁿ.' },
    { st: 4, tag: 'Regra', q: 'Potência de expoente negativo', a: 'a⁻ⁿ = 1/aⁿ (com a ≠ 0). Ex: 2⁻³ = 1/2³ = 1/8.' },
    { st: 4, tag: 'Regra', q: 'Potência de expoente 0', a: 'a⁰ = 1 para qualquer a ≠ 0.' },
    { st: 5, tag: 'Definição', q: 'O que é a raiz quadrada?', a: '√a é o número não negativo cujo quadrado é a. √64 = 8 porque 8² = 64.' },
    { st: 5, tag: 'Definição', q: 'O que é a raiz cúbica?', a: '∛a é o número cujo cubo é a. ∛27 = 3 porque 3³ = 27. Existe também para negativos: ∛(−8) = −2.' },
    { st: 6, tag: 'Definição', q: 'O que é notação científica?', a: 'Forma a × 10ⁿ, com 1 ≤ a < 10 e n inteiro. Ex: 225 000 000 = 2,25 × 10⁸.' },
    { st: 6, tag: 'Regra', q: 'Multiplicar em notação científica', a: '(a × 10ᵐ) × (b × 10ⁿ) = (a×b) × 10ᵐ⁺ⁿ. Se a×b ≥ 10, ajusta a mantissa e o expoente.' },
    { st: 6, tag: 'Regra', q: 'Dividir em notação científica', a: '(a × 10ᵐ) ÷ (b × 10ⁿ) = (a÷b) × 10ᵐ⁻ⁿ.' },
    { st: 6, tag: 'Exemplo', q: 'Escreve 0,0016 em notação científica', a: '0,0016 = 1,6 × 10⁻³.' },
    { st: 6, tag: 'Exemplo', q: 'Calcula (3 × 10⁴) × (6 × 10²)', a: '(3×6) × 10⁴⁺² = 18 × 10⁶ = 1,8 × 10⁷.' },
    { st: 5, tag: 'Exemplo', q: 'Calcula √64 − √36', a: '√64 − √36 = 8 − 6 = 2.' },
    { st: 1, tag: 'Definição', q: 'Que conjuntos numéricos conheces?', a: 'ℕ (naturais), ℤ (inteiros), ℚ (racionais). Todo o inteiro é racional e todo o natural é inteiro: ℕ ⊂ ℤ ⊂ ℚ.' },
    { st: 1, tag: 'Definição', q: 'O que é uma fração decimal?', a: 'Uma fração cujo denominador é uma potência de 10 (10, 100, 1000…). Ex: 3/10, 17/100. Dá sempre origem a uma dízima finita.' },
    { st: 1, tag: 'Regra', q: 'Como comparar dois números racionais?', a: 'Reduz ao mesmo denominador e compara os numeradores; ou converte ambos a dízima. Atenção aos negativos: quanto "mais negativo", menor.' },
    { st: 1, tag: 'Regra', q: 'Como transformar uma dízima finita em fração?', a: 'Escreve os algarismos sem vírgula sobre 10, 100… conforme as casas decimais. Ex: 0,24 = 24/100 = 6/25 (simplificada).' },
    { st: 2, tag: 'Regra', q: 'Regra dos sinais na multiplicação/divisão', a: 'Sinais iguais → resultado positivo; sinais diferentes → resultado negativo. Ex: (−2)×(−3)=6; (−2)×3=−6.' },
    { st: 2, tag: 'Definição', q: 'O que é o inverso de um número?', a: 'O inverso de a (≠0) é 1/a; o produto de um número pelo seu inverso é 1. O inverso de 3/5 é 5/3. (Não confundir com simétrico!)' },
    { st: 3, tag: 'Fórmula', q: 'Como calcular p% de um valor N?', a: 'p% de N = (p/100) × N. Ex: 5% de 6750 € = 0,05 × 6750 = 337,50 €.' },
    { st: 3, tag: 'Estratégia', q: 'Hierarquia das operações', a: '1.º parênteses; 2.º potências e raízes; 3.º multiplicação e divisão (da esquerda para a direita); 4.º adição e subtração.' },
    { st: 6, tag: 'Exemplo', q: 'Problema: Cândido pagou 4000 € em 4 prestações', a: 'Se já pagou frações conhecidas nas 3 primeiras, a 4.ª é o que falta para o todo (1): subtrai a soma das outras a 1 e multiplica por 4000 €.' },
    { st: 2, tag: 'Exemplo', q: 'Calcula (2/3)² × (3/4)', a: '(2/3)² = 4/9; 4/9 × 3/4 = 12/36 = 1/3.' }
  ],
  2: [
    { st: 2, tag: 'Definição', q: 'O que é um vetor?', a: 'Um segmento orientado caracterizado por direção, sentido e comprimento (norma). Em coordenadas: v(x, y). Representa-se por uma seta.' },
    { st: 2, tag: 'Definição', q: 'O que são vetores equipolentes?', a: 'Vetores com a mesma direção, o mesmo sentido e o mesmo comprimento. São representações do mesmo vetor.' },
    { st: 4, tag: 'Definição', q: 'O que é o vetor simétrico?', a: 'O vetor com a mesma direção e comprimento mas sentido oposto. As componentes têm o sinal trocado: −v de (3, −2) é (−3, 2).' },
    { st: 2, tag: 'Regra', q: 'Como somar vetores em coordenadas?', a: 'Somam-se as componentes: u(a, b) + v(c, d) = (a+c, b+d).' },
    { st: 1, tag: 'Definição', q: 'O que é uma translação?', a: 'A isometria que desloca todos os pontos a mesma distância, na mesma direção e sentido - segundo um vetor. P(x, y) → (x + vₓ, y + v_y).' },
    { st: 1, tag: 'Regra', q: 'Como aplicar uma translação a um ponto?', a: 'Soma as componentes do vetor às coordenadas do ponto. Ex: P(2, −5) pela translação de v(3, 7) → (5, 2).' },
    { st: 3, tag: 'Definição', q: 'O que é uma isometria?', a: 'Uma transformação que preserva as distâncias (e a forma). As quatro isometrias: translação, reflexão, rotação e reflexão deslizante.' },
    { st: 3, tag: 'Definição', q: 'O que é uma reflexão?', a: 'A isometria que produz a imagem "ao espelho" em relação a uma reta (o eixo de reflexão).' },
    { st: 3, tag: 'Definição', q: 'O que é uma rotação?', a: 'A isometria que faz girar a figura em torno de um ponto (centro) segundo um determinado ângulo e sentido.' },
    { st: 3, tag: 'Definição', q: 'O que é uma reflexão deslizante?', a: 'A composição de uma reflexão num eixo com uma translação segundo a direção desse eixo.' },
    { st: 3, tag: 'Conceito', q: 'Que tipos de simetria pode ter uma figura?', a: 'Simetria de translação, de reflexão (axial), de rotação e de reflexão deslizante. Os frisos e padrões (como os de Escher) combinam-nas.' },
    { st: 2, tag: 'Definição', q: 'O que é a norma (comprimento) de um vetor?', a: 'É o comprimento do segmento orientado. Em coordenadas, ‖v(a, b)‖ = √(a² + b²) (Teorema de Pitágoras).' },
    { st: 2, tag: 'Regra', q: 'Como subtrair vetores?', a: 'u − v = u + (−v): soma o primeiro com o simétrico do segundo. Em coordenadas: (a−c, b−d).' },
    { st: 2, tag: 'Definição', q: 'O que é o vetor nulo?', a: 'O vetor de comprimento zero, com componentes (0, 0). Somar o vetor nulo a outro não o altera.' },
    { st: 1, tag: 'Regra', q: 'Composição de duas translações', a: 'Aplicar a translação de u seguida da de v é o mesmo que uma única translação do vetor soma u + v.' },
    { st: 3, tag: 'Propriedade', q: 'As isometrias preservam o quê?', a: 'Preservam comprimentos, amplitudes de ângulos e áreas. A figura transformada é geometricamente igual à original (congruente).' },
    { st: 3, tag: 'Estratégia', q: 'Como identificar a simetria de um friso/padrão?', a: 'Procura: desliza e repete (translação); dobra num eixo (reflexão); roda em torno de um ponto (rotação); reflete e desliza (reflexão deslizante).' },
    { st: 1, tag: 'Exemplo', q: 'Contexto: um robô em (2, 1) move-se segundo v(4, −3)', a: 'A nova posição é (2+4, 1−3) = (6, −2). Cada movimento "soma" o vetor à posição atual.' },
    { st: 2, tag: 'Exemplo', q: 'Norma do vetor v(3, 4)?', a: '‖v‖ = √(3² + 4²) = √(9+16) = √25 = 5.' }
  ],
  3: [
    { st: 1, tag: 'Definição', q: 'O que é um monómio?', a: 'É o produto de um número (coeficiente) por uma parte literal com expoentes naturais. Ex: 5x⁴ tem coeficiente 5 e parte literal x⁴.' },
    { st: 1, tag: 'Definição', q: 'Qual é o grau de um monómio?', a: 'É a soma dos expoentes da parte literal. 5x⁴ tem grau 4; 4x²y² tem grau 4 (2+2).' },
    { st: 1, tag: 'Definição', q: 'O que são monómios semelhantes?', a: 'São monómios com a mesma parte literal. Ex: 3x²y e −7x²y são semelhantes. Só estes se podem somar/subtrair.' },
    { st: 2, tag: 'Regra', q: 'Como multiplicar monómios?', a: 'Multiplicam-se os coeficientes e somam-se os expoentes das mesmas variáveis. Ex: 3x² × 4x³ = 12x⁵.' },
    { st: 2, tag: 'Regra', q: 'Como somar monómios semelhantes?', a: 'Somam-se os coeficientes e mantém-se a parte literal. Ex: 5x³ + 9x³ = 14x³. (Não semelhantes não se somam.)' },
    { st: 3, tag: 'Definição', q: 'O que é um polinómio?', a: 'É uma soma de monómios. Ex: x² + 3x + 1. O grau do polinómio é o maior grau dos seus monómios.' },
    { st: 4, tag: 'Regra', q: 'Como simplificar um polinómio?', a: 'Juntam-se os termos semelhantes (mesma parte literal). Ex: 4xy + 3x − 2xy − 7x = 2xy − 4x.' },
    { st: 4, tag: 'Propriedade', q: 'Propriedade distributiva em polinómios', a: 'a(b + c) = ab + ac. Ex: 5(3x + 7) = 15x + 35. Usa-se para multiplicar um monómio por um polinómio.' },
    { st: 5, tag: 'Definição', q: 'O que é uma equação do 1.º grau?', a: 'Uma equação em que a incógnita aparece com expoente 1. Ex: 3x + 5 = 11. Tem (no máximo) uma solução.' },
    { st: 5, tag: 'Estratégia', q: 'Como resolver ax + b = c?', a: 'Isola o termo com x: ax = c − b. Depois divide: x = (c − b) / a. Ex: 3x + 5 = 11 → 3x = 6 → x = 2.' },
    { st: 6, tag: 'Estratégia', q: 'Como desembaraçar de denominadores?', a: 'Multiplica todos os termos pelo m.m.c. dos denominadores. Atenção: o sinal "−" antes de uma fração troca o sinal de todo o numerador.' },
    { st: 5, tag: 'Definição', q: 'O que são equações equivalentes?', a: 'Equações com a mesma solução. Obtêm-se aplicando os princípios de equivalência (somar/multiplicar o mesmo nos dois membros).' },
    { st: 5, tag: 'Exemplo', q: 'Resolve x/3 = 5', a: 'Multiplica ambos os membros por 3: x = 3 × 5 = 15.' },
    { st: 4, tag: 'Exemplo', q: 'Resolve 5(3x + 7)', a: 'Distributiva: 5 × 3x + 5 × 7 = 15x + 35.' },
    { st: 1, tag: 'Definição', q: 'O que é o coeficiente de um monómio?', a: 'É a parte numérica que multiplica a parte literal. Em −7x³, o coeficiente é −7. Um monómio sem letra (ex: 5) é um termo independente.' },
    { st: 3, tag: 'Definição', q: 'O que é um binómio e um trinómio?', a: 'Polinómios com 2 termos (binómio, ex: 3x + 1) ou 3 termos (trinómio, ex: x² + 2x + 1).' },
    { st: 5, tag: 'Regra', q: 'Princípios de equivalência das equações', a: '1) Somar/subtrair o mesmo nos dois membros. 2) Multiplicar/dividir os dois membros pelo mesmo número (≠0). A solução não muda.' },
    { st: 6, tag: 'Estratégia', q: 'Passos para resolver uma equação com parênteses e frações', a: '1.º desembaraça parênteses (distributiva); 2.º desembaraça denominadores (×m.m.c.); 3.º agrupa termos com x num membro; 4.º isola x.' },
    { st: 5, tag: 'Estratégia', q: 'Como traduzir um problema numa equação?', a: 'Chama x à quantidade desconhecida, escreve as relações do enunciado como uma igualdade, resolve e interpreta a solução no contexto.' },
    { st: 5, tag: 'Exemplo', q: 'Problema: o triplo de um número mais 4 é 19. Que número?', a: '3x + 4 = 19 → 3x = 15 → x = 5.' },
    { st: 2, tag: 'Exemplo', q: 'Simplifica 3x² × 2x³', a: 'Coeficientes: 3×2 = 6. Expoentes: 2+3 = 5. Resultado: 6x⁵.' },
    { st: 3, tag: 'Exemplo', q: 'Grau de 4x³ + 5x² + 10?', a: 'É o maior grau dos monómios: grau 3.' }
  ],
  4: [
    { st: 1, tag: 'Teorema', q: 'Enuncia o Teorema de Pitágoras', a: 'Num triângulo retângulo, o quadrado da hipotenusa é igual à soma dos quadrados dos catetos: a² + b² = c² (c = hipotenusa).' },
    { st: 1, tag: 'Definição', q: 'O que é a hipotenusa?', a: 'É o lado maior de um triângulo retângulo, oposto ao ângulo reto. Os outros dois lados são os catetos.' },
    { st: 1, tag: 'Regra', q: 'Como calcular a hipotenusa?', a: 'c = √(a² + b²). Ex: catetos 3 e 4 → c = √(9+16) = √25 = 5.' },
    { st: 1, tag: 'Regra', q: 'Como calcular um cateto?', a: 'Cateto = √(hipotenusa² − outro cateto²). Ex: hip 13, cateto 5 → √(169−25) = √144 = 12.' },
    { st: 2, tag: 'Propriedade', q: 'Recíproco do Teorema de Pitágoras', a: 'Se num triângulo o quadrado do maior lado for igual à soma dos quadrados dos outros dois, então o triângulo é retângulo.' },
    { st: 2, tag: 'Exemplo', q: '3, 4, 5 formam triângulo retângulo?', a: 'Sim: 3² + 4² = 9 + 16 = 25 = 5². É um terno pitagórico.' },
    { st: 2, tag: 'Exemplo', q: 'Ternos pitagóricos comuns', a: '(3,4,5), (5,12,13), (8,15,17), (7,24,25) e os seus múltiplos, como (6,8,10).' },
    { st: 3, tag: 'Estratégia', q: 'Diagonal de um retângulo', a: 'A diagonal é a hipotenusa do triângulo formado por dois lados: d = √(comprimento² + largura²).' },
    { st: 3, tag: 'Estratégia', q: 'Diagonal de um quadrado de lado L', a: 'd = √(L² + L²) = √(2L²) = L√2 ≈ 1,41 × L.' },
    { st: 1, tag: 'Definição', q: 'O que é o apótema de um polígono regular?', a: 'É a distância do centro ao ponto médio de um lado. Usa-se na área: A = (Perímetro × apótema) / 2.' },
    { st: 3, tag: 'Estratégia', q: 'Quando se usa o Teorema de Pitágoras em problemas?', a: 'Sempre que houver um ângulo reto: escadas encostadas a paredes, distâncias na diagonal, alturas, diagonais de retângulos e ecrãs.' },
    { st: 3, tag: 'Exemplo', q: 'Uma escada de 5 m encostada a uma parede, com a base a 3 m. A que altura chega?', a: 'altura = √(5² − 3²) = √(25−9) = √16 = 4 m.' },
    { st: 2, tag: 'Exemplo', q: 'Qual a diagonal de um ecrã 16 cm × 12 cm?', a: 'd = √(16² + 12²) = √(256+144) = √400 = 20 cm.' },
    { st: 2, tag: 'Regra', q: 'Como classificar um triângulo pelos lados (com o recíproco)?', a: 'Compara o maior lado² com a soma dos quadrados dos outros: igual → retângulo; maior² menor → acutângulo; maior² maior → obtusângulo.' },
    { st: 1, tag: 'Definição', q: 'O que é um terno pitagórico?', a: 'Um trio de números inteiros (a, b, c) com a² + b² = c². Ex: (3,4,5). Servem para encontrar triângulos retângulos com lados inteiros.' },
    { st: 3, tag: 'Estratégia', q: 'A raiz quadrada não é exata - o que fazer?', a: 'Deixa o resultado na forma de raiz (ex: √20) ou apresenta um valor aproximado às décimas com a calculadora (√20 ≈ 4,5).' }
  ],
  5: [
    { st: 1, tag: 'Definição', q: 'O que é uma equação literal?', a: 'Uma equação com mais do que uma letra (variáveis/parâmetros). Pode resolver-se "em ordem a" uma delas, isolando-a. Ex: P = 2(c + l) → c = P/2 − l.' },
    { st: 1, tag: 'Estratégia', q: 'Como resolver em ordem a uma variável?', a: 'Trata as outras letras como números: isola a variável pretendida usando as operações inversas, como numa equação normal.' },
    { st: 2, tag: 'Definição', q: 'O que é uma função?', a: 'Uma correspondência que associa a cada objeto (x) uma e uma só imagem (y). Escreve-se y = f(x).' },
    { st: 2, tag: 'Definição', q: 'O que é a imagem de um objeto?', a: 'É o valor f(x) que a função associa a x. Ex: se f(x) = 2x + 1, a imagem de 3 é f(3) = 2×3 + 1 = 7.' },
    { st: 3, tag: 'Definição', q: 'O que é uma função afim?', a: 'Uma função da forma y = mx + b. m é o declive e b é a ordenada na origem. O gráfico é uma reta.' },
    { st: 3, tag: 'Definição', q: 'O que é uma função linear?', a: 'Uma função afim com b = 0, ou seja y = mx. O gráfico é uma reta que passa na origem. Traduz proporcionalidade direta.' },
    { st: 4, tag: 'Definição', q: 'O que é o declive?', a: 'O declive m mede a inclinação da reta: quanto y varia quando x aumenta 1 unidade. m = (y₂ − y₁) / (x₂ − x₁).' },
    { st: 4, tag: 'Definição', q: 'O que é a ordenada na origem?', a: 'É o valor de y quando x = 0 (o b em y = mx + b). É o ponto onde a reta corta o eixo das ordenadas (Oy).' },
    { st: 3, tag: 'Regra', q: 'Retas paralelas - que relação têm?', a: 'Duas retas são paralelas se tiverem o mesmo declive (m igual). Ex: y = 2x + 1 e y = 2x − 3 são paralelas.' },
    { st: 4, tag: 'Exemplo', q: 'Calcula o declive entre A(1, 2) e B(3, 8)', a: 'm = (8 − 2) / (3 − 1) = 6 / 2 = 3.' },
    { st: 4, tag: 'Exemplo', q: 'Em y = −4x + 5, qual o declive e a ordenada na origem?', a: 'Declive m = −4; ordenada na origem b = 5.' },
    { st: 3, tag: 'Definição', q: 'O que é uma função constante?', a: 'Uma função do tipo y = b (declive 0). O gráfico é uma reta horizontal: o valor de y é sempre o mesmo, qualquer que seja x.' },
    { st: 2, tag: 'Estratégia', q: 'Como saber se um gráfico representa uma função?', a: 'Teste da reta vertical: se qualquer reta vertical corta o gráfico no máximo uma vez, é função (cada x tem uma só imagem).' },
    { st: 3, tag: 'Estratégia', q: 'Como descobrir a expressão de uma reta a partir do gráfico?', a: 'Lê a ordenada na origem (b, onde corta o eixo Oy) e calcula o declive (m) com dois pontos. A expressão é y = mx + b.' },
    { st: 4, tag: 'Definição', q: 'O que significa o declive ser positivo, negativo ou zero?', a: 'Positivo → reta cresce; negativo → reta decresce; zero → reta horizontal (função constante).' },
    { st: 3, tag: 'Exemplo', q: 'Tarifário: 5 € fixos + 2 € por GB. Expressão do custo?', a: 'C(x) = 2x + 5, onde x é o nº de GB. É uma função afim: declive 2 (€/GB), ordenada na origem 5 (€ fixos).' },
    { st: 3, tag: 'Exemplo', q: 'Um táxi cobra 3 € de partida + 1,5 €/km. Custo de 10 km?', a: 'C(x) = 1,5x + 3 → C(10) = 1,5×10 + 3 = 18 €.' },
    { st: 3, tag: 'Estratégia', q: 'Como traduzir uma situação real numa função afim?', a: 'A parte fixa é a ordenada na origem (b); o valor por unidade é o declive (m). Escreve y = mx + b.' }
  ],
  6: [
    { st: 1, tag: 'Definição', q: 'O que é uma equação com duas incógnitas?', a: 'Uma equação com duas letras, como 4x − 2y = 12. Tem infinitas soluções (pares ordenados) - o seu gráfico é uma reta.' },
    { st: 1, tag: 'Definição', q: 'O que é um sistema de equações?', a: 'Um conjunto de duas (ou mais) equações que se consideram em simultâneo. Escreve-se com uma chaveta { ... ; ... }.' },
    { st: 4, tag: 'Definição', q: 'O que é a solução de um sistema?', a: 'É o par (x, y) que satisfaz TODAS as equações ao mesmo tempo. Graficamente, é o ponto de interseção das retas.' },
    { st: 2, tag: 'Estratégia', q: 'Método de substituição', a: '1) Isola uma incógnita numa equação. 2) Substitui essa expressão na outra equação. 3) Resolve. 4) Substitui de volta para achar a outra incógnita.' },
    { st: 1, tag: 'Definição', q: 'Forma canónica de um sistema', a: 'Cada equação escrita como ax + by = c (termos com incógnitas de um lado, constante do outro), depois de desembaraçar parênteses e denominadores.' },
    { st: 1, tag: 'Definição', q: 'Sistemas equivalentes', a: 'Sistemas com a mesma solução. Obtêm-se aplicando os princípios de equivalência (somar/multiplicar o mesmo nos dois membros de uma equação).' },
    { st: 4, tag: 'Estratégia', q: 'Interpretação gráfica de um sistema', a: 'Cada equação é uma reta. A solução é o ponto onde as retas se cruzam. Retas paralelas → sem solução; coincidentes → infinitas soluções.' },
    { st: 4, tag: 'Exemplo', q: 'Como verificar se um par é solução do sistema?', a: 'Substitui o par nas duas equações. Só é solução se AMBAS se verificarem. Ex: (6, 2) em { x + 2y = 10 ; 3x − y = 16 } → 6+4=10 ✓ e 18−2=16 ✓ → é solução.' },
    { st: 2, tag: 'Exemplo', q: 'Resolve { x + y = 3 ; 4x − 3y = 33 }', a: 'Da 1.ª: x = 3 − y. Substitui: 4(3−y) − 3y = 33 → 12 − 7y = 33 → y = −3, x = 6. Solução (6, −3).' },
    { st: 3, tag: 'Estratégia', q: 'Como traduzir um problema num sistema?', a: 'Escolhe duas incógnitas (x e y) e escreve duas equações a partir das duas condições do enunciado. Resolve o sistema e interpreta.' },
  ...
  7: [
    ...
    { st: 2, tag: 'Fórmula', q: 'Volume de um cilindro', a: 'V = π × r² × h (a base é um círculo de área πr²). Ex: r = 4, h = 4 → V = π·16·4 = 64π cm³.' },
    { st: 3, tag: 'Fórmula', q: 'Volume de uma pirâmide', a: 'V = (área da base × altura) ÷ 3. É um terço do prisma com a mesma base e altura.' },
    { st: 4, tag: 'Fórmula', q: 'Volume de um cone', a: 'V = (π × r² × h) ÷ 3. É um terço do cilindro com a mesma base e altura.' },
    { st: 5, tag: 'Fórmula', q: 'Volume de uma esfera', a: 'V = (4 × π × r³) ÷ 3. Ex: r = 3 → V = (4·π·27)/3 = 36π cm³.' },
    { st: 6, tag: 'Fórmula', q: 'Área de um círculo', a: 'A = π × r². Perímetro (comprimento) da circunferência: P = 2 × π × r.' },
    { st: 2, tag: 'Definição', q: 'O que é a área lateral de um cilindro?', a: 'A superfície lateral planificada é um retângulo: A_lateral = 2πr × h (perímetro da base × altura).' },
    { st: 3, tag: 'Definição', q: 'O que é o apótema de uma pirâmide?', a: 'É a altura de uma face lateral (triângulo). Usa-se para calcular a área lateral da pirâmide.' },
    { st: 1, tag: 'Estratégia', q: 'Área total de um sólido', a: 'Soma das áreas de todas as faces/superfícies: A_total = A_base(s) + A_lateral. Usa a planificação para identificar todas as partes.' },
    { st: 6, tag: 'Definição', q: 'O que é um setor circular?', a: 'É uma "fatia" do círculo, limitada por dois raios e um arco. A sua área é proporcional à amplitude do ângulo ao centro.' },
    { st: 1, tag: 'Regra', q: 'O que é 1 litro em cm³ e dm³?', a: '1 litro = 1 dm³ = 1000 cm³. Útil para passar volumes de sólidos para capacidades (água, depósitos).' },
    { st: 1, tag: 'Estratégia', q: 'Como calcular o volume de um sólido composto?', a: 'Divide o sólido em partes simples (prisma, cilindro, cone…), calcula cada volume e soma-os (ou subtrai, se houver "buracos").' },
    { st: 2, tag: 'Exemplo', q: 'Volume de um depósito cilíndrico (r = 2 m, h = 5 m)?', a: 'V = π·r²·h = π·4·5 = 20π m³ ≈ 62,8 m³.' },
    { st: 1, tag: 'Exemplo', q: 'Volume de uma caixa (prisma) 10 × 4 × 3 cm?', a: 'V = área da base × altura = (10×4) × 3 = 120 cm³.' },
    { st: 1, tag: 'Definição', q: 'O que é a capacidade de um recipiente?', a: 'É o volume de líquido que ele pode conter, normalmente em litros. Calcula-se o volume e converte-se (1 L = 1000 cm³).' },
    { st: 6, tag: 'Estratégia', q: 'Quando se deixa o resultado em função de π?', a: 'Quando se quer o valor exato (ex: 20π cm³). Para um valor prático, multiplica-se por π ≈ 3,14 e arredonda-se.' }
  ],
  8: [
    { st: 1, tag: 'Definição', q: 'O que é a média?', a: 'A soma de todos os valores dividida pelo número de valores. Ex: média de 2, 4, 6 = (2+4+6)/3 = 4.' },
    { st: 2, tag: 'Definição', q: 'O que é a moda?', a: 'O valor (ou valores) que aparece mais vezes num conjunto de dados. Ex: em 3, 6, 6, 6, 7 a moda é 6.' },
    { st: 3, tag: 'Definição', q: 'O que é a mediana?', a: 'O valor central dos dados ORDENADOS. Se o nº de dados for par, é a média dos dois valores centrais.' },
    { st: 3, tag: 'Estratégia', q: 'Como calcular a mediana?', a: '1) Ordena os dados. 2) Se forem ímpares, é o do meio. 3) Se forem pares, é a média dos dois centrais. Ex: 8,9,10,14,20 → mediana = 10.' },
    { st: 4, tag: 'Definição', q: 'O que é a amplitude?', a: 'A diferença entre o maior e o menor valor: amplitude = máximo − mínimo. Mede a dispersão dos dados.' },
    { st: 4, tag: 'Definição', q: 'O que são os quartis?', a: 'Q1, Q2 (mediana) e Q3 dividem os dados ordenados em quatro partes iguais (25% cada). A amplitude interquartis é Q3 − Q1.' },
    { st: 6, tag: 'Definição', q: 'O que é a frequência absoluta?', a: 'O número de vezes que um valor (ou classe) ocorre nos dados.' },
    { st: 6, tag: 'Definição', q: 'O que é a frequência relativa?', a: 'A frequência absoluta dividida pelo total. Costuma exprimir-se em % : (fa ÷ total) × 100.' },
    { st: 5, tag: 'Regra', q: 'Como calcular uma probabilidade?', a: 'Em casos equiprováveis: P = casos favoráveis ÷ casos possíveis. O resultado está sempre entre 0 e 1.' },
    { st: 5, tag: 'Exemplo', q: 'P de sair par num dado?', a: 'Casos favoráveis (2,4,6) = 3; possíveis = 6. P = 3/6 = 1/2.' },
    { st: 5, tag: 'Exemplo', q: 'Probabilidade de um acontecimento certo / impossível', a: 'Acontecimento certo: P = 1. Acontecimento impossível: P = 0.' },
    { st: 1, tag: 'Definição', q: 'O que é população e amostra?', a: 'População é o conjunto total que se estuda; amostra é uma parte da população, escolhida para a representar.' },
    { st: 1, tag: 'Estratégia', q: 'Qual medida central usar?', a: 'Média: dados sem valores extremos. Mediana: resistente a extremos (ex: salários). Moda: dados qualitativos ou para o valor mais comum.' },
    { st: 1, tag: 'Exemplo', q: 'Notas de um aluno: 12, 14, 14, 16, 19. Média?', a: '(12+14+14+16+19)/5 = 75/5 = 15 valores.' },
    { st: 5, tag: 'Exemplo', q: 'P de tirar uma bola vermelha (5 em 20)?', a: 'P = 5/20 = 1/4 = 0,25 = 25%.' },
    { st: 5, tag: 'Regra', q: 'Como se exprime uma probabilidade?', a: 'Como fração (1/4), decimal (0,25) ou percentagem (25%) - formas equivalentes. Está sempre entre 0 e 1 (ou 0% e 100%).' },
    { st: 3, tag: 'Definição', q: 'O que é o diagrama de extremos e quartis?', a: 'Um gráfico (caixa de bigodes) que mostra o mínimo, Q1, mediana, Q3 e o máximo. Resume a distribuição e mostra a dispersão.' },
    { st: 6, tag: 'Estratégia', q: 'Como construir uma tabela de frequências?', a: 'Conta cada valor/classe (frequência absoluta), divide pelo total (frequência relativa) e acumula (frequência acumulada).' }
  ]
};
...
function mat8ResumoShowSts(cap) {
  ...
  var _stSel = _mat8Sel['resumo-st'] || 0;
  var h = '<div class="resumo-st-label">Subtema</div>';
  h += '<button class="resumo-st-btn' + (_stSel === 0 ? ' active' : '') + '" data-st="0" onclick="mat8ResumoSelectSt(this,' + cap + ',0)">Todos</button>';
...
var _mat8TarefaAtiva=null, _mat8TarefaResp={};
...
function mat8GerarExercicios() {
  ...
  var scoreBar = '<div class="score-bar" id="mat8-prat-scorebar">'
    ...
    + (_mat8TarefaAtiva ? '<button class="btn" style="background:#2e7d52;color:#fff;border:none;border-radius:999px;padding:6px 14px;font-weight:800;cursor:pointer;margin-left:.4rem" onclick="mat8EntregarTarefa()">\u2713 Terminar e entregar</button>' : '')
    + '</div>';
...
function mat8CheckEx(qid, tipo, val, btn) {
  ...
  _mat8Prat.score.total++; if(_mat8TarefaAtiva){_mat8TarefaResp[qid]=!!r.correct;}
...
function mat8JogosInit() {
  (function(){ var pj=document.getElementById('mat8p-jogos'); if(pj && !document.getElementById('mat8-jogos-atr')){ var d=document.createElement('div'); d.id='mat8-jogos-atr'; d.style.margin='0 0 .8rem'; if(pj.firstChild) pj.insertBefore(d,pj.firstChild); else pj.appendChild(d); } if(typeof Atribuir!=='undefined'&&Atribuir.montar) Atribuir.montar('mat8-jogos-atr',{curso:'mat8',cursoNome:'Matemática 8.º',tipo:'jogo',nivel:'',caps:_mat8CapMeta.map(function(mm){return {n:mm.n,label:mm.label};})}); })();
  ...
  if (typeof _j24AutoInit === 'function') {
    ...
    if (typeof _gRegisterGameCourse === 'function') {
      _gRegisterGameCourse('mat8-jogos-app', {
        capMeta: _mat8CapMeta,
        subtemas: _mat8Subtemas,
        subtemaTemas: (typeof _mat8SubtemaTemas !== 'undefined') ? _mat8SubtemaTemas : null,
        temasCount: _mat8TemasCount,
        gerador: _mat8Gerador,
        banco: (typeof _mat8Banco !== 'undefined') ? _mat8Banco : null,
...
function mat8FichasBuildNav() {
  if(typeof Atribuir!=='undefined'&&Atribuir.fixo) Atribuir.fixo('mat8-fichas-atr','mat8AtribuirFicha');
...
function _mat8gfGenExs(cap, n) {
  ...
  if (banco.length && typeof _mixBancoGeradas === 'function') {
    return _mixBancoGeradas(banco, geradas, n, Math.min(Math.ceil(n / 3), banco.length), _mat8gf.dif);
  }
  return geradas;
}
...
function mat8gfGerar(formato) {
  ...
  // Secção de soluções
  var solHTML = '';
  if (_mat8gf.tipos.solucoes && eduPodeSolucoes() && solucoes.length) {
...
function mat8AtribuirFicha(){
  var caps=[]; _mat8CapMeta.forEach(function(m){ if(_mat8gf.caps[m.n]) caps.push(m.n); });
  if(!caps.length){ var st=document.getElementById('mat8-fichas-status'); if(st) st.textContent='Escolhe pelo menos um capítulo para atribuir.'; return null; }
  var nomes=caps.map(function(n){ var mm=_mat8CapMeta[n-1]||{}; return mm.label||('Cap. '+n); });
  return { curso:'mat8', cursoNome:'Matemática 8.º', tema:caps.join('.'), temaNome:nomes.join(', '), sub:'', subNome:'', tipo:'ficha', nivel:_mat8gf.dif };
}

function mat8EntregarTarefa(){
  if(!_mat8TarefaAtiva||typeof Turmas==='undefined'||!Turmas.guardarResultado)return;
  var qids=Object.keys(_mat8TarefaResp||{});
  if(!qids.length){alert('Responde a pelo menos uma pergunta antes de entregar.');return;}
  var certas=0,detalhe=[];
  qids.forEach(function(qid,i){ var ok=!!_mat8TarefaResp[qid]; if(ok)certas++; var ex=_mat8Prat.exs[i]||{}; detalhe.push({q:(ex.enun||ex.pergunta||('Pergunta '+(i+1))),certo:ok}); });
  Turmas.guardarResultado(_mat8TarefaAtiva,certas,qids.length,detalhe).then(function(){
    ...
    _mat8TarefaAtiva=null; _mat8TarefaResp={}; mat8GerarExercicios();
