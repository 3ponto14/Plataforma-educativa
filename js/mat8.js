...
function _mat8DeepLinkAuto(){ try{ var p=new URLSearchParams(window.location.search); if(p.get('abrir')==='jogos'){ setTimeout(function(){ mat8SwitchTab('jogos',null); },350); return; }
